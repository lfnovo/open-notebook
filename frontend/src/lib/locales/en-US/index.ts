export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The Backpack API server could not be reached",
    ...
    docLink: "Backpack Documentation",
  ...
  modules: {
    ...
    deleteModuleDesc: "Are you sure you want to delete this module? This action cannot be undone.",
    activeModules: "Active Modules",
    archivedModules: "Archived Modules",
    emptyDescription: "Start by creating your first module to organize your research.",
    noActiveModules: "No active modules",
    noArchivedModules: "No archived modules",
    notFound: "Module not found",
    notFoundDesc: "The requested module does not exist.",
    ...
    descPlaceholder: "Add more info about this module here...",
  ...
  sources: {
    ...
    cannotSaveNoteNoModule: "Cannot save note: module ID not available",
    ...
    sourcesAddedToModule: "{count} source(s) added to module",
    failedToAddSourcesToModule: "Failed to add sources to module",
    partialAddSuccess: "{success} source(s) added, {failed} failed",
    sourceRemovedFromModule: "Source removed from module successfully",
    failedToRemoveSourceFromModule: "Failed to remove source from module",
    removeConfirm: "Are you sure you want to remove this from the module?",
    checking: "Checking...",
    ...
    batchCommonSettings: 'The same modules and transformations will be applied to all items.',
    ...
    manageModulesDesc: "Manage which modules contain this source",
    ...
    addExistingDesc: "Select existing sources from across all your modules to add to the current one.",
  ...
  chat: {
    ...
    chatWithModule: 'Chat with Module',
    unableToLoadChat: 'Unable to load chat',
    noDescription: 'No description',
    startByCreating: 'Start by creating your first module to organize your research.',
  ...
  searchPage: {
    ...
    notSet: "Not set",
    saveToModule: "Save to Module",
    saveSuccess: "Successfully saved to module",
    saveError: "Failed to save to module",
  ...
  podcasts: {
    ...
    content: "Content",
    contentDesc: "Pick modules, sources, and notes to include in this episode.",
    itemsSelected: "{count} items selected",
    tokens: "{count} tokens",
    chars: "{count} chars",
    loadingModules: "Loading modules...",
    noModulesFoundInPodcasts: "No modules found. Create a module and add content before generating a podcast.",
    ...
    sources: "Sources",
    notes: "Notes",
    noSources: "No sources available in this module.",
    noNotes: "No notes available in this module.",
    ...
    noEpisodesYet: "No podcast episodes yet. Generate your first one from the module or source chat interfaces.",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Backpack to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Backpack is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    desc: "Configure AI models for different purposes across Backpack",
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Backpack",
    missingRequiredModels: "Missing required models: {models}. Backpack may not function properly without these.",
