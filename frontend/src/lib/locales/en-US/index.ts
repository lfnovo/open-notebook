export const enUS = {
  ...
  connectionErrors: {
    ...
    docLink: "AgentBook Documentation",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow AgentBook to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of AgentBook is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across AgentBook",
    missingRequiredModels: "Missing required models: {models}. AgentBook may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in AgentBook.",
