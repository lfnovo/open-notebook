...
The official `docker-compose.yml` is in the root of our repository: [View on GitHub](https://github.com/stefanini-applications/sai-notebook/blob/main/docker-compose.yml)
