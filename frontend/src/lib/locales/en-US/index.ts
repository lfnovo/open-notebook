export const enUS = {
  ...
  chat: {
    ...
    selfExplainTitle: "Try self-explanation",
  ...
  usage: {
    ...
    costMeterDesc: "Estimated LLM spend for the selected period",
    periodMonth: "Month",
    periodYear: "Year",
    loadError: "Failed to load usage data",
    usedOfBudget: "of {{budget}} budget",
    percentUsed: "{{percent}}% of budget used",
  ...
  study: {
    listTitle: "Study Sets",
    listDesc: "Flashcards and quizzes generated from your notebooks",
    generateBtn: "Generate Study Set",
    generateTitle: "Generate Study Set",
    generateDesc: "Create flashcards or a quiz from a notebook's content",
    notebookLabel: "Notebook",
    notebookPlaceholder: "Select a notebook",
    interleavingHint: "Draws on every source and note in the notebook — add a few different topics before generating to mix them into one study set.",
    kindLabel: "Type",
    kindFlashcards: "Flashcards",
    kindQuiz: "Quiz",
    nameLabel: "Name",
    namePlaceholder: "e.g. Chapter 3 Review",
    itemCountLabel: "Number of items",
    modelLabel: "Model",
    modelDefault: "Default",
    notebookRequired: "Notebook required",
    notebookRequiredDesc: "Select a notebook to generate from",
    nameRequired: "Name required",
    nameRequiredDesc: "Give this study set a name",
    generating: "Generating...",
    generatingDesc: "This can take a minute depending on the model and content size",
    generationStarted: "Generation started",
    generationSubmittedDesc: "We'll let you know when \"{{name}}\" is ready",
    generationComplete: "Study set ready",
    generationCompleteDesc: "\"{{name}}\" is ready to study",
    generationFailed: "Generation failed",
    tryAgain: "Try Again",
    close: "Close",
    noNotebooks: "No notebooks yet",
    noNotebooksDesc: "Create a notebook with some content first",
    loadingNotebooks: "Loading notebooks...",
    loadingSets: "Loading study sets...",
    loadErrorTitle: "Failed to load study sets",
    loadErrorDesc: "Please try again",
    noSetsYet: "No study sets yet",
    noSetsYetDesc: "Generate flashcards or a quiz from any notebook to get started",
    total: "Total",
    filterAll: "All",
    itemsCount: "{{count}} item(s)",
    view: "View",
    deleteSet: "Delete",
    deleteSetTitle: "Delete Study Set",
    deleteSetDesc: "Are you sure you want to delete \"{{name}}\"? This action cannot be undone.",
    deleteSuccess: "Study set deleted",
    deleteFailed: "Failed to delete study set",
    failedLabel: "Failed",
    backToList: "Back to Study Sets",
    createdOn: "Created {{time}}",
    modelUsed: "Model",
    notFound: "Study set not found",
    notFoundDesc: "This study set may have been deleted.",
    flipCard: "Flip",
    ...
    reviewPrompt: "How well did you know this?",
    reviewAheadHint: "This card isn't due yet — reviewing it now still counts.",
    ...
    guidedSession: {
      quickModeTab: "Quick mode",
      guidedModeTab: "AI-guided mode",
      noCardsDue: "No cards due for review right now.",
      answerPlaceholder: "Type your answer...",
      submitAnswer: "Answer",
      grading: "Grading your answer...",
      attemptLabel: "Attempt {{current}} of {{max}}",
      hintLabel: "Hint from your last attempt",
      correctLabel: "Correct!",
      incorrectLabel: "Incorrect",
      revealedAnswerLabel: "Answer",
      tryAgainBtn: "Try again",
      nextCard: "Next card",
      sessionComplete: "Session complete!",
      sessionSummary: "You mastered {{mastered}} of {{total}} cards.",
      allMasteredMessage: "All set! You can move on to the next set.",
      needsWorkTitle: "Cards that need more review",
  ...
  drive: {
    title: "Google Drive",
    description: "Connect a Google Drive account to import files as sources",
    ...
    importDialogDesc: "Pick a file from your connected Google Drive to import as a source",
    connectPromptDesc: "Connect Google Drive in Settings to import files from it",
    goToSettings: "Go to Settings",
    searchPlaceholder: "Search Drive files...",
    filesLoadError: "Failed to load Drive files",
    noFilesFound: "No files found",
    loadMore: "Load more",
    import: "Import",
    importFailed: "Failed to import file from Drive",
  },
  settings: {
  ...
  models: {
    ...
    fallbackChainLabel: "Automatic fallback (in order)",
    fallbackChainEmpty: "No fallback models configured. If the primary fails, the request fails.",
    fallbackChainUnknownModel: "Unknown model (deleted?)",
    fallbackChainMoveUp: "Move up",
    fallbackChainMoveDown: "Move down",
    fallbackChainRemove: "Remove from fallback chain",
    fallbackChainAdd: "Add fallback model",
  },
  apiKeys: {
