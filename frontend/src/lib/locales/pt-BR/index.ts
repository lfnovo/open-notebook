export const ptBR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do AgentBook não pôde ser alcançado",
    ...
    docLink: "Documentação do AgentBook",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o AgentBook exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do AgentBook está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no AgentBook",
    missingRequiredModels: "Modelos obrigatórios ausentes: {models}. O AgentBook pode não funcionar corretamente sem eles.",
  ...
  apiKeys: {
    ...
    description: "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no AgentBook.",
