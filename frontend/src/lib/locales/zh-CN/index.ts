...
export const zhCN = {
  ...
  usage: {
    costMeter: "费用计量",
    costMeterDesc: "所选周期内的预估 LLM 花费",
    periodMonth: "月",
    periodYear: "年",
    loadError: "加载使用数据失败",
    usedOfBudget: "/ {{budget}} 预算",
    percentUsed: "已使用预算的 {{percent}}%",
  ...
  study: {
    listTitle: "学习集",
    listDesc: "根据你的笔记本生成的抽认卡和测验",
    generateBtn: "生成学习集",
    generateTitle: "生成学习集",
    generateDesc: "根据笔记本内容创建抽认卡或测验",
    notebookLabel: "笔记本",
    notebookPlaceholder: "选择一个笔记本",
    interleavingHint: "会使用笔记本中的所有资料和笔记——生成前加入几个不同的主题，即可在同一个学习集里混合练习。",
    kindLabel: "类型",
    kindFlashcards: "抽认卡",
    kindQuiz: "测验",
    nameLabel: "名称",
    namePlaceholder: "例如：第 3 章复习",
    itemCountLabel: "项目数量",
    modelLabel: "模型",
    modelDefault: "默认",
    notebookRequired: "需要选择笔记本",
    notebookRequiredDesc: "请选择一个用于生成内容的笔记本",
    nameRequired: "需要名称",
    nameRequiredDesc: "为此学习集命名",
    generating: "正在生成...",
    generatingDesc: "根据模型和内容大小，这可能需要一分钟左右",
    generationStarted: "已开始生成",
    generationSubmittedDesc: "当 \"{{name}}\" 准备就绪时会通知你",
    generationComplete: "学习集已就绪",
    generationCompleteDesc: "\"{{name}}\" 已可以开始学习",
    generationFailed: "生成失败",
    tryAgain: "重试",
    close: "关闭",
    noNotebooks: "暂无笔记本",
    noNotebooksDesc: "请先创建一个包含内容的笔记本",
    loadingNotebooks: "正在加载笔记本...",
    loadingSets: "正在加载学习集...",
    loadErrorTitle: "加载学习集失败",
    loadErrorDesc: "请重试",
    noSetsYet: "暂无学习集",
    noSetsYetDesc: "从任意笔记本生成抽认卡或测验以开始使用",
    total: "总计",
    filterAll: "全部",
    itemsCount: "{{count}} 项",
    view: "查看",
    deleteSet: "删除",
    deleteSetTitle: "删除学习集",
    deleteSetDesc: "确定要删除 \"{{name}}\" 吗？此操作无法撤销。",
    deleteSuccess: "学习集已删除",
    deleteFailed: "删除学习集失败",
    failedLabel: "失败",
    backToList: "返回学习集列表",
    createdOn: "创建于 {{time}}",
    modelUsed: "模型",
    notFound: "未找到学习集",
    notFoundDesc: "此学习集可能已被删除。",
    flipCard: "翻转",
    cardProgress: "第 {{current}} / {{total}} 张卡片",
    previous: "上一个",
    ...
    dueCount: "{{count}} 张待复习",
    allCaughtUp: "已全部复习",
    reviewPrompt: "你对这张卡片的掌握程度如何?",
    reviewAheadHint: "这张卡片还未到复习时间——现在复习依然会被记录。",
    reviewFailed: "保存复习结果失败",
    rating: {
      again: "重来",
      hard: "较难",
      good: "掌握",
    ...
    guidedSession: {
      quickModeTab: "快速模式",
      guidedModeTab: "AI 引导模式",
      noCardsDue: "目前没有需要复习的卡片。",
      answerPlaceholder: "输入你的答案...",
      submitAnswer: "回答",
      grading: "正在评估你的答案...",
      attemptLabel: "第 {{current}} 次尝试(共 {{max}} 次)",
      hintLabel: "上次尝试的提示",
      correctLabel: "正确!",
      incorrectLabel: "错误",
      ...
      tryAgainBtn: "重试",
      nextCard: "下一张卡片",
      sessionComplete: "本次学习已完成!",
      sessionSummary: "你已掌握 {{total}} 张卡片中的 {{mastered}} 张。",
      allMasteredMessage: "太棒了!你可以继续学习下一组。",
      needsWorkTitle: "需要加强复习的卡片",
      continueBtn: "继续",
  ...
  drive: {
    title: "Google 云端硬盘",
    description: "连接 Google 云端硬盘账户以将文件导入为来源",
    connect: "连接 Google 云端硬盘",
    connectFailed: "连接 Google 云端硬盘失败",
    connected: "Google 云端硬盘已连接",
    connectedAs: "已连接为 {{email}}",
    connectedNoEmail: "已连接",
    notConnected: "未连接",
    disconnect: "断开连接",
    disconnected: "Google 云端硬盘已断开连接",
    disconnectFailed: "断开 Google 云端硬盘连接失败",
    importFromDrive: "从云端硬盘导入",
    importDialogDesc: "从已连接的 Google 云端硬盘中选择要导入为来源的文件",
    connectPromptDesc: "请在设置中连接 Google 云端硬盘以导入文件",
    goToSettings: "前往设置",
    searchPlaceholder: "搜索云端硬盘文件...",
    filesLoadError: "加载云端硬盘文件失败",
    noFilesFound: "未找到文件",
    loadMore: "加载更多",
    import: "导入",
    importFailed: "从云端硬盘导入文件失败",
  },
  settings: {
  ...
  models: {
    ...
    fallbackChainLabel: "自动故障转移（按顺序）",
    fallbackChainEmpty: "尚未配置故障转移模型。如果主模型失败，请求将失败。",
    fallbackChainUnknownModel: "未知模型（已删除？）",
    fallbackChainMoveUp: "上移",
    fallbackChainMoveDown: "下移",
    fallbackChainRemove: "从故障转移链中移除",
    fallbackChainAdd: "添加故障转移模型",
  },
  apiKeys: {
  ...
  askSources: {
    triggerLabel: "跨多个来源提问",
    title: "同时向多个来源提问",
    description: "选择要合并的来源(包括整本书),提出一个问题——在后台运行,永远不会超时,答案会保存为笔记。",
    selectSourcesLabel: "要包含的来源",
    noSources: "这个笔记本还没有来源。",
    questionLabel: "你的问题",
    questionPlaceholder: "这些来源对...有什么看法?",
    running: "正在处理...",
    runningDesc: "如果有多个大型来源可能需要更长时间——答案准备好后会保存为笔记。",
    failed: "生成答案时出了点问题。",
    submitBtn: "提问",
    completeTitle: "答案已保存",
    completeDesc: "查看笔记面板以获取答案。",
    questionRequired: "请先写一个问题",
    selectAtLeastOne: "至少选择一个来源",
    submitError: "无法启动请求",
  },
