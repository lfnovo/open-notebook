...
connectionErrors: {
  ...
  sources: {
    ...
    emptyDesc: "Ajoutez votre première source pour commencer à bâtir votre base de connaissances.",
    delete: "Supprimer la source",
    deleteMsg: "Êtes-vous sûr de vouloir supprimer cette source ? Cette action est irréversible.",
    ...
    failedToRetryDesc: "Échec de la relance du traitement de la source. Veuillez réessayer.",
    ...
    titleRequiredForText: "Le titre est requis pour les sources textuelles",
  ...
  advanced: {
    ...
    systemInfoDesc: "Consultez l'état des composants sous-jacents du système",
    ...
    rebuildWarning: "Cette action peut prendre beaucoup de temps selon le nombre de sources. Elle effacera les index vectoriels existants et régénérera les embeddings pour tout le contenu.",
    startRebuild: "Lancer la reconstruction",
    rebuilding: "Reconstruction...",
    rebuildSuccess: "La reconstruction des embeddings a démarré avec succès",
  ...
  transformations: {
    ...
    deleteDesc: "La suppression de cette transformation est irréversible.",
  ...
  models: {
    ...
    desc: "Configurez les modèles d'IA pour les différents usages d'Open Notebook",
    failedToLoad: "Échec du chargement des données des modèles",
    language: "Modèles de Langage",
    ...
    changeEmbeddingWarning: "Changer le modèle d'embedding par défaut affectera les nouvelles sources. Les sources existantes devront peut-être être ré-indexées.",
    changeEmbeddingTitle: "Changer le modèle d'embedding par défaut ?",
    ...
    seeLess: "Voir moins",
    seeAll: "Voir les {count} fournisseurs",
    language_models: "Modèles de Langage",
    embedding_models: "Modèles d'Embedding",
    text_to_speech: "Synthèse vocale (TTS)",
    speech_to_text: "Transcription vocale (STT)",
    languageDesc: "Chat, transformations et génération de texte",
    embeddingDesc: "Recherche sémantique et indexation vectorielle",
    ttsDesc: "Générer de l'audio à partir de texte",
    sttDesc: "Transcrire de l'audio en texte",
    all: "Tous",
    noModelsConfigured: "Aucun modèle configuré",
    noProviderModelsConfigured: "Aucun modèle {provider} configuré",
    showMore: "Afficher {count} de plus",
    deleteModel: "Supprimer le modèle",
    deleteModelDesc: "Êtes-vous sûr de vouloir supprimer \"{name}\" ? Cette action est irréversible.",
    ...
    whichModelToChoose: "Quel modèle choisir ? →",
    ...
    addSpecificModelDesc: "Configurez un nouveau modèle {type} à partir des fournisseurs disponibles.",
    ...
    adding: "Ajout en cours...",
    azureHint: "Pour Azure, utilisez le nom du déploiement comme nom de modèle",
