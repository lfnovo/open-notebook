...
def update_existing_transformation(transformation_id, name, title, description, prompt, apply_default):
    try:
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        try:
            ...
            update_existing_transformation(transformation_id, name, title, description, prompt, apply_default)
