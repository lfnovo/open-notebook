export const zhTW = {
  ...
  connectionErrors: {
    ...
    apiDesc: "無法存取 SAI Notebook API 伺服器",
    dbTitle: "資料庫連線失敗",
  ...
  sources: {
    ...
    includeLinkedPages: "包含連結頁面",
    includeLinkedPagesHint: "掃描此頁面中的連結，並選擇要作為個別來源匯入的連結",
    selectLinks: "選擇連結",
    selectLinksDescription: "選擇要作為個別來源匯入的連結頁面",
    scanningLinks: "正在掃描頁面中的連結…",
    linksFound: "找到 {count} 個連結",
    noLinksFound: "此頁面未找到連結。將僅匯入原始頁面。",
    selectAll: "全選",
    selectNone: "全部取消",
    selectSameDomain: "選擇同網站連結",
    sameDomainBadge: "同網站",
    externalBadge: "外部",
    discoverLinksError: "無法掃描頁面中的連結。",
    skipImportOriginal: "略過 — 僅匯入原始頁面",
    addSource: "新增來源",
  ...
  advanced: {
    ...
    updateAvailableDesc: "SAI Notebook 的新版本可用。",
    upToDate: "已是最新",
    unknown: "未知",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "設定用於 SAI Notebook 不同用途的預設模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有這些模型，SAI Notebook 可能無法正常運行。",
  ...
  apiKeys: {
    ...
    description: "將 API 金鑰安全地儲存在資料庫中，以在 SAI Notebook 中啟用 AI 服務商。",
