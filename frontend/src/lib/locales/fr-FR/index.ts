export const frFR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de SAI Notebook est injoignable",
    ...
    docLink: "Documentation de SAI Notebook",
  ...
  sources: {
    ...
    includeLinkedPages: "Inclure les pages liées",
    includeLinkedPagesHint: "Analyser cette page pour trouver des liens et choisir lesquels importer comme sources distinctes",
    selectLinks: "Sélectionner les liens",
    selectLinksDescription: "Choisissez les pages liées à importer comme sources distinctes",
    scanningLinks: "Recherche de liens sur la page…",
    linksFound: "{count} lien(s) trouvé(s)",
    noLinksFound: "Aucun lien trouvé sur cette page. Seule la page d'origine sera importée.",
    selectAll: "Tout sélectionner",
    selectNone: "Tout désélectionner",
    selectSameDomain: "Sélectionner le même site",
    sameDomainBadge: "même site",
    externalBadge: "externe",
    discoverLinksError: "Impossible d'analyser les liens de la page.",
    skipImportOriginal: "Ignorer — importer uniquement l'original",
  ...
  settings: {
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser SAI Notebook à supprimer automatiquement les fichiers du dossier de téléchargement.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Une nouvelle version de SAI Notebook est disponible.",
    upToDate: "À jour",
    unknown: "Inconnu",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configurez quels modèles utiliser pour les différents usages d'SAI Notebook",
    missingRequiredModels: "Modèles requis manquants : {models}. SAI Notebook pourrait ne pas fonctionner correctement sans eux.",
  ...
  apiKeys: {
    ...
    description: "Stockez les clés API de manière sécurisée dans la base de données pour activer les fournisseurs d'IA dans SAI Notebook.",
