...
export const bnIN = {
  ...
  settings: {
    ...
    formulasEnabled: "সূত্র নিষ্কাশন সক্ষম করুন",
    formulasHelp: "Docling ইঞ্জিন ব্যবহারের সময় ডকুমেন্ট থেকে গাণিতিক সূত্র বের করে। প্রক্রিয়া করতে ধীর।",
    visionEnabled: "ভিশন এনরিচমেন্ট সক্ষম করুন",
    visionHelp: "Docling ইঞ্জিন ব্যবহারের সময় ডকুমেন্টে চার্ট, ছবি এবং ডায়াগ্রাম বিশ্লেষণ করে। উল্লেখযোগ্যভাবে ধীর এবং একটি ভিশন মডেল কল করতে পারে।",
