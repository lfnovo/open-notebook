"""
Generic ContextBuilder for the Open Module project.

This module provides a flexible ContextBuilder class that can handle any parameters
and build context from sources, modules, insights, and notes.
"""
...
from backpack.domain.module import Module, Note, Source
from backpack.exceptions import DatabaseOperationError, NotFoundError
...
class ContextBuilder:
    ...
    from sources, modules, insights, and notes.
    """
    ...
    def __init__(self, **kwargs):
        ...
        - module_id: str - Include module content
        ...
        self.module_id: Optional[str] = kwargs.get("module_id")
    ...
    async def build(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.module_id:
                await self._add_module_context(self.module_id)
    ...
    async def _add_module_context(self, module_id: str) -> None:
        """
        Add module content based on context configuration.
        ...
        try:
            ...
            logger.debug(f"Added module context for {module_id}")

        except Exception as e:
            logger.error(f"Error adding module context for {module_id}: {str(e)}")
            raise
...
async def build_module_context(
    ...
    builder = ContextBuilder(
        module_id=module_id, context_config=context_config, max_tokens=max_tokens
    )
