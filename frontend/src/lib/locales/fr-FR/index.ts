...
export const frFR = {
  ...
  chat: {
    ...
    selfExplainTitle: "Essayez l'auto-explication",
  ...
  usage: {
    costMeter: "Compteur de Coût",
    costMeterDesc: "Dépense LLM estimée pour la période sélectionnée",
    periodMonth: "Mois",
    periodYear: "Année",
    loadError: "Échec du chargement des données d'utilisation",
    usedOfBudget: "sur {{budget}} de budget",
    percentUsed: "{{percent}}% du budget utilisé",
    inputTokens: "Jetons d'entrée",
    outputTokens: "Jetons de sortie",
    byTaskType: "Par type de tâche",
    noUsageYet: "Aucune utilisation enregistrée pour le moment",
  },
  study: {
    listTitle: "Ensembles d'Étude",
    listDesc: "Cartes mémoire et quiz générés à partir de vos carnets",
    generateBtn: "Générer un Ensemble d'Étude",
    generateTitle: "Générer un Ensemble d'Étude",
    generateDesc: "Créez des cartes mémoire ou un quiz à partir du contenu d'un carnet",
    notebookLabel: "Carnet",
    notebookPlaceholder: "Sélectionner un carnet",
    interleavingHint: "S'appuie sur toutes les sources et notes du carnet — ajoutez plusieurs sujets différents avant de générer pour les mélanger dans un même ensemble d'étude.",
    kindLabel: "Type",
    kindFlashcards: "Cartes mémoire",
    kindQuiz: "Quiz",
    nameLabel: "Nom",
    namePlaceholder: "p. ex. Révision du Chapitre 3",
    itemCountLabel: "Nombre d'éléments",
    modelLabel: "Modèle",
    modelDefault: "Par défaut",
    notebookRequired: "Carnet requis",
    notebookRequiredDesc: "Sélectionnez un carnet à partir duquel générer",
    nameRequired: "Nom requis",
    nameRequiredDesc: "Donnez un nom à cet ensemble d'étude",
    generating: "Génération en cours...",
    generatingDesc: "Cela peut prendre une minute selon le modèle et la taille du contenu",
    generationStarted: "Génération démarrée",
    generationSubmittedDesc: "Nous vous préviendrons quand \"{{name}}\" sera prêt",
    generationComplete: "Ensemble d'étude prêt",
    generationCompleteDesc: "\"{{name}}\" est prêt à étudier",
    generationFailed: "Échec de la génération",
    tryAgain: "Réessayer",
    close: "Fermer",
    noNotebooks: "Aucun carnet pour le moment",
    noNotebooksDesc: "Créez d'abord un carnet avec du contenu",
    loadingNotebooks: "Chargement des carnets...",
    loadingSets: "Chargement des ensembles d'étude...",
    loadErrorTitle: "Échec du chargement des ensembles d'étude",
    loadErrorDesc: "Veuillez réessayer",
    noSetsYet: "Aucun ensemble d'étude pour le moment",
    noSetsYetDesc: "Générez des cartes mémoire ou un quiz depuis n'importe quel carnet pour commencer",
    total: "Total",
    filterAll: "Tous",
    itemsCount: "{{count}} élément(s)",
    view: "Voir",
    deleteSet: "Supprimer",
    deleteSetTitle: "Supprimer l'Ensemble d'Étude",
    deleteSetDesc: "Voulez-vous vraiment supprimer \"{{name}}\" ? Cette action est irréversible.",
    deleteSuccess: "Ensemble d'étude supprimé",
    deleteFailed: "Échec de la suppression de l'ensemble d'étude",
    failedLabel: "Échoué",
    backToList: "Retour aux Ensembles d'Étude",
    createdOn: "Créé {{time}}",
    modelUsed: "Modèle",
    notFound: "Ensemble d'étude introuvable",
    notFoundDesc: "Cet ensemble d'étude a peut-être été supprimé.",
    flipCard: "Retourner",
    cardProgress: "Carte {{current}} sur {{total}}",
    previous: "Précédent",
    question: "Question {{current}} sur {{total}}",
    grade: "Corriger le Quiz",
    reset: "Réinitialiser",
    yourScore: "Votre score : {{score}}/{{total}}",
    correct: "Correct",
    incorrect: "Incorrect",
    explanation: "Explication",
    exportAnki: "Exporter vers Anki (.csv)",
    filterDue: "À réviser",
    dueCount: "{{count}} à réviser",
    allCaughtUp: "Tout est à jour",
    reviewPrompt: "À quel point la connaissiez-vous ?",
    reviewAheadHint: "Cette carte n'était pas encore due — la réviser maintenant compte quand même.",
    reviewFailed: "Échec de l'enregistrement de la révision",
    rating: {
      again: "À revoir",
      hard: "Difficile",
      good: "Bien",
    ...
    guidedSession: {
      quickModeTab: "Mode rapide",
      guidedModeTab: "Mode guidé par IA",
      noCardsDue: "Aucune carte à réviser pour le moment.",
      answerPlaceholder: "Tapez votre réponse...",
      submitAnswer: "Répondre",
      grading: "Évaluation de votre réponse...",
      attemptLabel: "Tentative {{current}} sur {{max}}",
      hintLabel: "Indice de votre dernière tentative",
      correctLabel: "Correct !",
      incorrectLabel: "Incorrect",
      revealedAnswerLabel: "Réponse",
      tryAgainBtn: "Réessayer",
      nextCard: "Carte suivante",
      sessionComplete: "Session terminée !",
      sessionSummary: "Vous avez maîtrisé {{mastered}} carte(s) sur {{total}}.",
      allMasteredMessage: "C'est prêt ! Vous pouvez passer au set suivant.",
      needsWorkTitle: "Cartes à revoir davantage",
  ...
  drive: {
    title: "Google Drive",
    description: "Connectez un compte Google Drive pour importer des fichiers comme sources",
    connect: "Connecter Google Drive",
    connectFailed: "Échec de la connexion à Google Drive",
    ...
    disconnectFailed: "Échec de la déconnexion de Google Drive",
    importFromDrive: "Importer depuis Drive",
    importDialogDesc: "Choisissez un fichier de votre Google Drive connecté à importer comme source",
    connectPromptDesc: "Connectez Google Drive dans les Paramètres pour en importer des fichiers",
    goToSettings: "Aller aux Paramètres",
    searchPlaceholder: "Rechercher des fichiers Drive...",
    filesLoadError: "Échec du chargement des fichiers Drive",
    noFilesFound: "Aucun fichier trouvé",
    loadMore: "Charger plus",
    import: "Importer",
    importFailed: "Échec de l'importation du fichier depuis Drive",
  },
  settings: {
  ...
  models: {
    ...
    fallbackChainLabel: "Basculement automatique (dans l'ordre)",
    fallbackChainEmpty: "Aucun modèle de secours configuré. Si le modèle principal échoue, la requête échoue.",
    fallbackChainUnknownModel: "Modèle inconnu (supprimé ?)",
    fallbackChainMoveUp: "Monter",
    fallbackChainMoveDown: "Descendre",
    fallbackChainRemove: "Retirer de la chaîne de secours",
    fallbackChainAdd: "Ajouter un modèle de secours",
  },
  apiKeys: {
  ...
  askSources: {
    triggerLabel: "Interroger plusieurs sources",
    title: "Interroger plusieurs sources à la fois",
    description: "Choisissez les sources à combiner (livres entiers inclus) et posez une question — s'exécute en arrière-plan pour ne jamais expirer, et la réponse est enregistrée comme note.",
    selectSourcesLabel: "Sources à inclure",
    noSources: "Ce cahier n'a pas encore de sources.",
    questionLabel: "Votre question",
    questionPlaceholder: "Que disent ces sources à propos de...?",
    running: "En cours...",
    runningDesc: "Cela peut prendre un peu plus de temps avec plusieurs grandes sources — la réponse sera enregistrée comme note une fois prête.",
    failed: "Une erreur s'est produite lors de la génération de la réponse.",
    submitBtn: "Demander",
    completeTitle: "Réponse enregistrée",
    completeDesc: "Consultez le panneau Notes pour voir la réponse.",
    questionRequired: "Écrivez d'abord une question",
    selectAtLeastOne: "Sélectionnez au moins une source",
    submitError: "Impossible de démarrer la demande",
  },
