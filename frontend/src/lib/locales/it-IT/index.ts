...
export const itIT = {
  ...
  settings: {
    ...
    formulasEnabled: "Abilita estrazione formule",
    formulasHelp: "Estrae formule matematiche dai documenti quando si usa il motore Docling. Elaborazione più lenta.",
    visionEnabled: "Abilita arricchimento visivo",
    visionHelp: "Analizza grafici, immagini e diagrammi nei documenti quando si usa il motore Docling. Notevolmente più lento e potrebbe chiamare un modello di visione.",
