export const itIT = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di SAI Notebook non è raggiungibile",
    ...
    docLink: "Documentazione SAI Notebook",
  ...
  sources: {
    ...
    includeLinkedPages: "Includi pagine collegate",
    includeLinkedPagesHint: "Analizza questa pagina per trovare link e scegli quali importare come fonti separate",
    selectLinks: "Seleziona link",
    selectLinksDescription: "Scegli quali pagine collegate importare come fonti separate",
    scanningLinks: "Ricerca di link nella pagina…",
    linksFound: "{count} link trovati",
    noLinksFound: "Nessun link trovato in questa pagina. Verrà importata solo la pagina originale.",
    selectAll: "Seleziona tutto",
    selectNone: "Deseleziona tutto",
    selectSameDomain: "Seleziona stesso sito",
    sameDomainBadge: "stesso sito",
    externalBadge: "esterno",
    discoverLinksError: "Impossibile analizzare i link della pagina.",
    skipImportOriginal: "Salta — importa solo l'originale",
  ...
  settings: {
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a SAI Notebook di eliminare automaticamente i file caricati dalla cartella upload.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "È disponibile una nuova versione di SAI Notebook.",
    upToDate: "Aggiornato",
    unknown: "Sconosciuto",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in SAI Notebook",
    missingRequiredModels: "Modelli richiesti mancanti: {models}. SAI Notebook potrebbe non funzionare correttamente senza questi.",
  ...
  apiKeys: {
    ...
    description: "Salva le chiavi API in modo sicuro nel database per abilitare i provider IA in SAI Notebook.",
