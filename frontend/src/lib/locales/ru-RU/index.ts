...
export const ruRU = {
  ...
  settings: {
    ...
    formulasEnabled: "Включить извлечение формул",
    formulasHelp: "Извлекает математические формулы из документов при использовании движка Docling. Обработка медленнее.",
    visionEnabled: "Включить обогащение изображений",
    visionHelp: "Анализирует диаграммы, изображения и схемы в документах при использовании движка Docling. Значительно медленнее и может вызвать модель зрения.",
