...
export const itIT = {
  ...
  chat: {
    ...
    selfExplainTitle: "Prova l'autospiegazione",
  ...
  usage: {
    costMeter: "Misuratore di Costo",
    costMeterDesc: "Spesa LLM stimata per il periodo selezionato",
    periodMonth: "Mese",
    periodYear: "Anno",
    loadError: "Impossibile caricare i dati di utilizzo",
    usedOfBudget: "di {{budget}} di budget",
    percentUsed: "{{percent}}% del budget utilizzato",
    inputTokens: "Token in ingresso",
    outputTokens: "Token in uscita",
    byTaskType: "Per tipo di attività",
    noUsageYet: "Nessun utilizzo registrato ancora",
  },
  study: {
    listTitle: "Set di Studio",
    listDesc: "Flashcard e quiz generati dai tuoi taccuini",
    generateBtn: "Genera Set di Studio",
    generateTitle: "Genera Set di Studio",
    generateDesc: "Crea flashcard o un quiz dal contenuto di un taccuino",
    notebookLabel: "Taccuino",
    notebookPlaceholder: "Seleziona un taccuino",
    interleavingHint: "Attinge a tutte le fonti e note del taccuino — aggiungi alcuni argomenti diversi prima di generare per mescolarli in un unico set di studio.",
    kindLabel: "Tipo",
    kindFlashcards: "Flashcard",
    kindQuiz: "Quiz",
    nameLabel: "Nome",
    namePlaceholder: "es. Ripasso Capitolo 3",
    itemCountLabel: "Numero di elementi",
    modelLabel: "Modello",
    modelDefault: "Predefinito",
    notebookRequired: "Taccuino obbligatorio",
    notebookRequiredDesc: "Seleziona un taccuino da cui generare",
    nameRequired: "Nome obbligatorio",
    nameRequiredDesc: "Assegna un nome a questo set di studio",
    generating: "Generazione in corso...",
    generatingDesc: "Può richiedere circa un minuto a seconda del modello e della dimensione del contenuto",
    generationStarted: "Generazione avviata",
    generationSubmittedDesc: "Ti avviseremo quando \"{{name}}\" sarà pronto",
    generationComplete: "Set di studio pronto",
    generationCompleteDesc: "\"{{name}}\" è pronto per lo studio",
    generationFailed: "Generazione non riuscita",
    tryAgain: "Riprova",
    close: "Chiudi",
    noNotebooks: "Ancora nessun taccuino",
    noNotebooksDesc: "Crea prima un taccuino con del contenuto",
    loadingNotebooks: "Caricamento taccuini...",
    loadingSets: "Caricamento set di studio...",
    loadErrorTitle: "Impossibile caricare i set di studio",
    loadErrorDesc: "Riprova",
    noSetsYet: "Ancora nessun set di studio",
    noSetsYetDesc: "Genera flashcard o un quiz da qualsiasi taccuino per iniziare",
    total: "Totale",
    filterAll: "Tutti",
    itemsCount: "{{count}} elemento/i",
    view: "Visualizza",
    deleteSet: "Elimina",
    deleteSetTitle: "Elimina Set di Studio",
    deleteSetDesc: "Sei sicuro di voler eliminare \"{{name}}\"? Questa azione non può essere annullata.",
    deleteSuccess: "Set di studio eliminato",
    deleteFailed: "Impossibile eliminare il set di studio",
    failedLabel: "Non riuscito",
    backToList: "Torna ai Set di Studio",
    createdOn: "Creato {{time}}",
    modelUsed: "Modello",
    notFound: "Set di studio non trovato",
    notFoundDesc: "Questo set di studio potrebbe essere stato eliminato.",
    flipCard: "Gira",
    ...
    exportAnki: "Esporta in Anki (.csv)",
    filterDue: "Da ripassare",
    dueCount: "{{count}} da ripassare",
    allCaughtUp: "Tutto in regola",
    reviewPrompt: "Quanto bene lo sapevi?",
    reviewAheadHint: "Questa carta non era ancora in scadenza — ripassarla ora conta comunque.",
    reviewFailed: "Impossibile salvare il ripasso",
    rating: {
      again: "Di nuovo",
      hard: "Difficile",
      good: "Bene",
    ...
    guidedSession: {
      quickModeTab: "Modalità rapida",
      guidedModeTab: "Modalità guidata con IA",
      noCardsDue: "Al momento non ci sono carte da ripassare.",
      answerPlaceholder: "Scrivi la tua risposta...",
      submitAnswer: "Rispondi",
      grading: "Valutazione della risposta...",
      attemptLabel: "Tentativo {{current}} di {{max}}",
      hintLabel: "Suggerimento dal tuo ultimo tentativo",
      correctLabel: "Corretto!",
      incorrectLabel: "Errato",
      revealedAnswerLabel: "Risposta",
      tryAgainBtn: "Riprova",
      nextCard: "Carta successiva",
      sessionComplete: "Sessione completata!",
      sessionSummary: "Hai padroneggiato {{mastered}} di {{total}} carte.",
      allMasteredMessage: "Fatto! Puoi passare al set successivo.",
      needsWorkTitle: "Carte che necessitano di altro ripasso",
  ...
  drive: {
    title: "Google Drive",
    description: "Collega un account Google Drive per importare file come fonti",
    connect: "Collega Google Drive",
    connectFailed: "Impossibile collegare Google Drive",
    connected: "Google Drive collegato",
    connectedAs: "Collegato come {{email}}",
    connectedNoEmail: "Collegato",
    notConnected: "Non collegato",
    disconnect: "Scollega",
    disconnected: "Google Drive scollegato",
    disconnectFailed: "Impossibile scollegare Google Drive",
    importFromDrive: "Importa da Drive",
    importDialogDesc: "Scegli un file dal tuo Google Drive collegato da importare come fonte",
    connectPromptDesc: "Collega Google Drive nelle Impostazioni per importarne i file",
    goToSettings: "Vai alle Impostazioni",
    searchPlaceholder: "Cerca file su Drive...",
    filesLoadError: "Impossibile caricare i file di Drive",
    noFilesFound: "Nessun file trovato",
    loadMore: "Carica altri",
    import: "Importa",
    importFailed: "Impossibile importare il file da Drive",
  },
  settings: {
  ...
  models: {
    ...
    fallbackChainLabel: "Fallback automatico (in ordine)",
    fallbackChainEmpty: "Nessun modello di fallback configurato. Se il modello principale fallisce, la richiesta fallisce.",
    fallbackChainUnknownModel: "Modello sconosciuto (eliminato?)",
    fallbackChainMoveUp: "Sposta su",
    fallbackChainMoveDown: "Sposta giù",
    fallbackChainRemove: "Rimuovi dalla catena di fallback",
    fallbackChainAdd: "Aggiungi modello di fallback",
  },
  apiKeys: {
  ...
  askSources: {
    triggerLabel: "Chiedi su più fonti",
    title: "Chiedi su più fonti insieme",
    description: "Scegli le fonti da combinare (libri interi inclusi) e fai una domanda — viene eseguita in background così non va mai in timeout, e la risposta viene salvata come nota.",
    selectSourcesLabel: "Fonti da includere",
    noSources: "Questo notebook non ha ancora fonti.",
    questionLabel: "La tua domanda",
    questionPlaceholder: "Cosa dicono queste fonti su...?",
    running: "Sto elaborando...",
    runningDesc: "Può richiedere un po' più di tempo con più fonti grandi — la risposta verrà salvata come nota quando sarà pronta.",
    failed: "Qualcosa è andato storto nella generazione della risposta.",
    submitBtn: "Chiedi",
    completeTitle: "Risposta salvata",
    completeDesc: "Controlla il pannello Note per la risposta.",
    questionRequired: "Scrivi prima una domanda",
    selectAtLeastOne: "Seleziona almeno una fonte",
    submitError: "Impossibile avviare la richiesta",
  },
