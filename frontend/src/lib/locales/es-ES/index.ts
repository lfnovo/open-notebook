export const esES = {
  ...
  connectionErrors: {
    ...
    apiDesc: "No se pudo alcanzar el servidor API de SAI Notebook",
    ...
    docLink: "Documentación de SAI Notebook",
  ...
  sources: {
    ...
    includeLinkedPages: "Incluir páginas enlazadas",
    includeLinkedPagesHint: "Analizar esta página en busca de enlaces y elegir cuáles importar como fuentes separadas",
    selectLinks: "Seleccionar enlaces",
    selectLinksDescription: "Elige qué páginas enlazadas importar como fuentes separadas",
    scanningLinks: "Buscando enlaces en la página…",
    linksFound: "{count} enlace(s) encontrado(s)",
    noLinksFound: "No se encontraron enlaces en esta página. Solo se importará la página original.",
    selectAll: "Seleccionar todo",
    selectNone: "Deseleccionar todo",
    selectSameDomain: "Seleccionar del mismo sitio",
    sameDomainBadge: "mismo sitio",
    externalBadge: "externo",
    discoverLinksError: "No se pudieron analizar los enlaces de la página.",
    skipImportOriginal: "Omitir — importar solo la original",
  ...
  settings: {
    ...
    filesHelp: "Una vez que tus archivos se suben y procesan, ya no son necesarios. La mayoría de los usuarios deberían permitir que SAI Notebook elimine los archivos subidos de la carpeta de carga automáticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Una nueva versión de SAI Notebook está disponible.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura qué modelos usar para diferentes propósitos en SAI Notebook",
    missingRequiredModels: "Faltan modelos requeridos: {models}. SAI Notebook puede no funcionar correctamente sin estos.",
  ...
  apiKeys: {
    ...
    description: "Almacena claves API de forma segura en la base de datos para habilitar proveedores de IA en SAI Notebook.",
