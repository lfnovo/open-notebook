...
git clone https://github.com/YOUR_USERNAME/agent-book.git
cd agent-book
...
- **First Issue?** Pick a [good first issue](https://github.com/lfnovo/agent-book/issues?q=label%3A%22good+first+issue%22)
