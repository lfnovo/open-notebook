...
export const ptBR = {
  ...
  chat: {
    ...
    selfExplainTitle: "Experimente a autoexplicação",
  ...
  usage: {
    costMeter: "Medidor de Custo",
    costMeterDesc: "Gasto estimado com LLM no período selecionado",
    periodMonth: "Mês",
    periodYear: "Ano",
    loadError: "Falha ao carregar dados de uso",
    usedOfBudget: "de {{budget}} de orçamento",
    percentUsed: "{{percent}}% do orçamento utilizado",
    inputTokens: "Tokens de entrada",
    outputTokens: "Tokens de saída",
    byTaskType: "Por tipo de tarefa",
    noUsageYet: "Nenhum uso registrado ainda",
  },
  study: {
    listTitle: "Conjuntos de Estudo",
    listDesc: "Flashcards e questionários gerados a partir dos seus notebooks",
    generateBtn: "Gerar Conjunto de Estudo",
    generateTitle: "Gerar Conjunto de Estudo",
    generateDesc: "Crie flashcards ou um questionário a partir do conteúdo de um notebook",
    notebookLabel: "Notebook",
    notebookPlaceholder: "Selecione um notebook",
    interleavingHint: "Usa todas as fontes e notas do notebook — adicione alguns tópicos diferentes antes de gerar para misturá-los em um único conjunto de estudo.",
    kindLabel: "Tipo",
    kindFlashcards: "Flashcards",
    kindQuiz: "Questionário",
    nameLabel: "Nome",
    namePlaceholder: "ex.: Revisão do Capítulo 3",
    itemCountLabel: "Número de itens",
    modelLabel: "Modelo",
    modelDefault: "Padrão",
    notebookRequired: "Notebook obrigatório",
    notebookRequiredDesc: "Selecione um notebook para gerar o conteúdo",
    nameRequired: "Nome obrigatório",
    nameRequiredDesc: "Dê um nome a este conjunto de estudo",
    generating: "Gerando...",
    generatingDesc: "Isso pode levar um minuto, dependendo do modelo e do tamanho do conteúdo",
    generationStarted: "Geração iniciada",
    generationSubmittedDesc: "Avisaremos quando \"{{name}}\" estiver pronto",
    generationComplete: "Conjunto de estudo pronto",
    generationCompleteDesc: "\"{{name}}\" está pronto para estudar",
    generationFailed: "Falha na geração",
    tryAgain: "Tentar Novamente",
    close: "Fechar",
    noNotebooks: "Nenhum notebook ainda",
    noNotebooksDesc: "Crie um notebook com algum conteúdo primeiro",
    loadingNotebooks: "Carregando notebooks...",
    loadingSets: "Carregando conjuntos de estudo...",
    loadErrorTitle: "Falha ao carregar conjuntos de estudo",
    loadErrorDesc: "Tente novamente",
    noSetsYet: "Nenhum conjunto de estudo ainda",
    noSetsYetDesc: "Gere flashcards ou um questionário a partir de qualquer notebook para começar",
    total: "Total",
    filterAll: "Todos",
    itemsCount: "{{count}} item(ns)",
    view: "Ver",
    deleteSet: "Excluir",
    deleteSetTitle: "Excluir Conjunto de Estudo",
    deleteSetDesc: "Tem certeza de que deseja excluir \"{{name}}\"? Esta ação não pode ser desfeita.",
    deleteSuccess: "Conjunto de estudo excluído",
    deleteFailed: "Falha ao excluir conjunto de estudo",
    failedLabel: "Falhou",
    backToList: "Voltar aos Conjuntos de Estudo",
    createdOn: "Criado {{time}}",
    modelUsed: "Modelo",
    notFound: "Conjunto de estudo não encontrado",
    notFoundDesc: "Este conjunto de estudo pode ter sido excluído.",
    flipCard: "Virar",
    cardProgress: "Cartão {{current}} de {{total}}",
    previous: "Anterior",
    question: "Pergunta {{current}} de {{total}}",
    grade: "Corrigir Questionário",
    reset: "Reiniciar",
    yourScore: "Sua pontuação: {{score}}/{{total}}",
    correct: "Correto",
    incorrect: "Incorreto",
    explanation: "Explicação",
    exportAnki: "Exportar para Anki (.csv)",
    filterDue: "Para revisar",
    dueCount: "{{count}} pendentes",
    allCaughtUp: "Tudo em dia",
    reviewPrompt: "O quanto você sabia disso?",
    reviewAheadHint: "Este cartão ainda não estava programado — revisá-lo agora também conta.",
    reviewFailed: "Falha ao salvar a revisão",
    rating: {
      again: "De novo",
      hard: "Difícil",
      good: "Bom",
    ...
    guidedSession: {
      ...
      guidedModeTab: "Modo guiado com IA",
      noCardsDue: "Não há cartões pendentes de revisão agora.",
      answerPlaceholder: "Digite sua resposta...",
      submitAnswer: "Responder",
      grading: "Avaliando sua resposta...",
      attemptLabel: "Tentativa {{current}} de {{max}}",
      hintLabel: "Dica da sua última tentativa",
      ...
      sessionSummary: "Você dominou {{mastered}} de {{total}} cartões.",
      allMasteredMessage: "Pronto! Você pode seguir para o próximo conjunto.",
      needsWorkTitle: "Cartões que precisam de mais revisão",
  ...
  drive: {
    title: "Google Drive",
    description: "Conecte uma conta do Google Drive para importar arquivos como fontes",
    connect: "Conectar Google Drive",
    connectFailed: "Falha ao conectar o Google Drive",
    ...
    disconnectFailed: "Falha ao desconectar o Google Drive",
    importFromDrive: "Importar do Drive",
    importDialogDesc: "Escolha um arquivo do seu Google Drive conectado para importar como fonte",
    connectPromptDesc: "Conecte o Google Drive em Configurações para importar arquivos dele",
    goToSettings: "Ir para Configurações",
    searchPlaceholder: "Buscar arquivos do Drive...",
    filesLoadError: "Falha ao carregar arquivos do Drive",
    noFilesFound: "Nenhum arquivo encontrado",
    loadMore: "Carregar mais",
    import: "Importar",
    importFailed: "Falha ao importar arquivo do Drive",
  },
  settings: {
  ...
  models: {
    ...
    fallbackChainLabel: "Failover automático (em ordem)",
    fallbackChainEmpty: "Nenhum modelo de fallback configurado. Se o modelo principal falhar, a solicitação falhará.",
    fallbackChainUnknownModel: "Modelo desconhecido (excluído?)",
    fallbackChainMoveUp: "Mover para cima",
    fallbackChainMoveDown: "Mover para baixo",
    fallbackChainRemove: "Remover da cadeia de fallback",
    fallbackChainAdd: "Adicionar modelo de fallback",
  },
  apiKeys: {
  ...
  askSources: {
    triggerLabel: "Perguntar em várias fontes",
    title: "Perguntar em várias fontes ao mesmo tempo",
    description: "Escolha as fontes para combinar (livros inteiros incluídos) e faça uma pergunta — roda em segundo plano para nunca travar, e a resposta é salva como nota.",
    selectSourcesLabel: "Fontes a incluir",
    noSources: "Este notebook ainda não tem fontes.",
    questionLabel: "Sua pergunta",
    questionPlaceholder: "O que essas fontes dizem sobre...?",
    running: "Trabalhando nisso...",
    runningDesc: "Pode demorar um pouco mais com várias fontes grandes — a resposta será salva como nota quando estiver pronta.",
    failed: "Algo deu errado ao gerar a resposta.",
    submitBtn: "Perguntar",
    completeTitle: "Resposta salva",
    completeDesc: "Confira o painel de Notas para ver a resposta.",
    questionRequired: "Escreva uma pergunta primeiro",
    selectAtLeastOne: "Selecione pelo menos uma fonte",
    submitError: "Não foi possível iniciar a solicitação",
  },
