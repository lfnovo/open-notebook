...
This document outlines the core principles, vision, and design philosophy that guide SAI Notebook's development. All contributors should read and understand these principles before proposing changes or new features.

## 🎯 Project Vision

SAI Notebook aims to be a **privacy-focused, self-hosted alternative to Google's Notebook LM** that empowers users to:
