export const enUS = {
  ...
  auth: {
    ...
    changePasswordDesc: "Update your account password used for signing in.",
    changePasswordButton: "Change Password",
    changePasswordSuccess: "Password changed successfully.",
    changePasswordError: "Failed to change password.",
    changePasswordMismatch: "New passwords do not match.",
    changePasswordTooShort: "New password must be at least 4 characters.",
    changePasswordFillAllFields: "Please fill in all password fields.",
    currentPasswordIncorrect: "Current password is incorrect.",
    signingIn: "Signing in...",
    signIn: "Sign In",
    signInWithWeChat: "Sign in with WeChat",
    weChatNotConfigured: "WeChat login is not configured. Please contact the administrator.",
    weChatCallbackTitle: "Signing in with WeChat",
    weChatCallbackDesc: "Please wait while Lumina completes the secure login.",
    weChatCallbackMissingCode: "WeChat did not return an authorization code.",
    weChatCallbackFailed: "WeChat login failed. Please return to the login page and try again.",
    connectErrorHint: "Unable to connect to server. Please check if the API is running.",
    brandSlogan: "Illuminating the path of discovery · Unlocking life's infinite possibilities",
    brandTagline: "Illuminating Discovery, Advancing Life.",
    loginIdentifierPlaceholder: "Username / Email / Researcher ID",
    rememberMe: "Remember me",
    forgotPassword: "Forgot password?",
    loginDivider: "or",
    registerNewAccount: "Register new account",
    registerWithWeChat: "Sign up or sign in with WeChat",
    ...
    registerDesc: "Sign up with your email to get started",
    ...
    registerDisabled: "Public registration is currently disabled",
    ...
    forgotPasswordNewPasswordPlaceholder: "New password (min 6 characters)",
    ...
    forgotPasswordInvalidCode: "Invalid or expired code",
    resetPasswordTitle: "Set New Password",
    resetPasswordDesc: "Enter the code from your email and your new password",
    resetPasswordCodePlaceholder: "Verification code",
    resetPasswordNewPasswordPlaceholder: "New password (min 6 characters)",
    resetPasswordButton: "Set Password",
    resettingPassword: "Setting password...",
  },
  navigation: {
    collect: "Collect",
    process: "Process",
    ...
    sources: "Sources",
    notebooks: "Notebooks",
    askAndSearch: "Knowledge Explorer",
    podcasts: "Podcasts",
    models: "Models",
  ...
  externalApi: {
    description: "System-managed third-party sources, team grants, and monthly request quotas.",
    connectionOverview: "Active connections",
    sourceOverview: "Configured sources",
    sourceOverviewDetail: "Available for team grants",
    teamOverview: "Workspace teams",
    teamOverviewDetail: "Grant targets",
    connections: "Connections",
    connectionsDescription: "Endpoint, API key, and API target are configured once by system admins.",
    noConnections: "No external API connections configured.",
    noConnectionsHint: "Add a source or output connection before granting team access.",
    enabled: "Enabled",
    disabled: "Disabled",
    ...
    addConnectionFor: "Add {target} connection",
    addSourceIntegration: "Add source integration",
    addOutputIntegration: "Add output integration",
    endpointConfiguration: "Endpoint configuration",
    sourceDefinition: "Source definition",
    connectionNameHint: "Use a recognizable provider or plugin name.",
    apiTarget: "API target",
    sourceApi: "Source",
    outputArtifactApi: "Output artifact",
    sourceApiDescription: "Use this endpoint to search and fetch connected sources.",
    outputApiDescription: "Use this endpoint to generate output artifacts.",
    noSourceConnections: "Create a source-targeted connection first.",
    baseUrl: "Base URL",
    apiKey: "API Key",
    timeoutSeconds: "Timeout seconds",
    timeoutValue: "{seconds}s timeout",
    sources: "Sources",
    sourcesDescription: "Sources use source-targeted connections and can later be granted to teams.",
    noSources: "No external sources configured.",
    noSourcesHint: "Define a source from a source connection, then authorize it for a team.",
    addSource: "Add Source",
    sourceSetup: "Source setup",
    sourceSetupDescription: "Define source capabilities and grant quota to teams.",
    grantSetupDescription: "Authorize configured sources to workspace teams and set monthly request quota.",
    ...
    noLinkedSource: "No source definition",
    showDetails: "Details",
    hideDetails: "Hide",
    grantToTeam: "Grant To Team",
    authorizedTeams: "Authorized teams",
    noTeamGrants: "No teams authorized yet.",
    team: "Team",
    selectSource: "Select source",
    selectTeam: "Select team",
    monthlyRequestQuota: "Monthly request quota",
    quotaValue: "Quota {quota}/month",
    grant: "Grant",
    grantPrerequisite: "Create at least one source and workspace team before granting access.",
    allTeamsGranted: "All workspace teams are already authorized.",
    lastTest: "Last Test",
    ...
    quotaUsage: "Quota {usage} this month",
    switchToTeamWorkspace: "Switch to a team workspace to use authorized external sources.",
    noAuthorizedSources: "No external sources are authorized for this team.",
    searchPlaceholder: "Search external source",
    searchAction: "Search external source",
    waitingForResults: "Waiting for results...",
    joining: "Adding source...",
    noResults: "No results returned.",
    join: "Join",
    joinFailed: "Failed to add source.",
    connectedSource: "Deep Search",
    connectedSourceDescription: "Search an authorized third-party source, then join a result as a source.",
    targetNotebook: "Target notebook",
    selectTargetNotebook: "Select target notebook",
    selectTargetNotebookFirst: "Select a target notebook before using deep search.",
    fetch: "Fetch",
    reference: "Ref",
    snapshot: "Snapshot",
  },
  profile: {
    ...
    saved: "Profile saved.",
    completeTitle: "Verify email to continue",
    completeDescription: "Use the email for this account, then set a password for email sign-in.",
    passwordBindingHint: "If this email already exists, WeChat will be bound to that account and the existing password will not be changed.",
    username: "Username",
    email: "Email",
    ...
    emailBound: "WeChat bound to the existing email account.",
  ...
  teams: {
    ...
    modelDefaults: "Team default models",
    modelDefaultsDesc: "Choose this team's default models from the system-approved available models. Blank fields inherit the system defaults for regular users.",
    inheritSystemDefault: "Inherit system default",
    clearTeamDefault: "Clear team default",
    noTeamModelsAvailable: "No models have been made available to this team.",
    modelDefaultsSaved: "Team default models updated.",
    allowedModels: "Allowed models",
    allowedModelsDesc: "Choose which configured models this team can use.",
    allowedTransformations: "Allowed transformations",
    allowedTransformationsDesc: "Choose which configured transformations this team can use.",
    noModelsAvailable: "No configured models available.",
    noTransformationsAvailable: "No configured transformations available.",
    allowlistSaved: "Team access updated.",
    workspacePolicy: "Workspace permissions",
    workspacePolicyDesc: "Configure what members can do in this team's workspace. System limits may still lock some actions.",
    workspacePolicyUpdated: "Workspace permissions updated.",
    failedToUpdateWorkspacePolicy: "Failed to update workspace permissions.",
    noWorkspacePolicy: "No team workspace was found for this team.",
    policyLockedBySystem: "Disabled by system policy.",
    policyCreateSource: "Members can add sources",
    policyCreateSourceDesc: "Allow members to add new sources to team notebooks.",
    policyUpdateOwnSource: "Members can edit own sources",
    policyUpdateOwnSourceDesc: "Allow members to update sources they added.",
    policyProcessOwnSource: "Members can process own sources",
    policyProcessOwnSourceDesc: "Allow members to retry processing and generate derived content for sources they added.",
    policyRemoveSource: "Members can remove sources",
    policyRemoveSourceDesc: "Allow members to remove sources from team notebooks.",
    policyCreateNote: "Members can add notes",
    policyCreateNoteDesc: "Allow members to add notes to team notebooks.",
    policyUpdateOwnNote: "Members can edit own notes",
    policyUpdateOwnNoteDesc: "Allow members to edit notes they created.",
    policyDeleteOwnNote: "Members can delete own notes",
    policyDeleteOwnNoteDesc: "Allow members to delete notes they created.",
    policyUpdateNotebook: "Members can edit own notebooks",
    policyUpdateNotebookDesc: "Allow members to edit metadata on notebooks they created.",
    guideTitle: "Standard team flow",
    guideDescription: "Use this sequence to keep team membership and shared access understandable.",
    guideCreateTeam: "Create or select the right team",
    guideAssignMembers: "Assign the least role each member needs",
    guideReviewShares: "Review shares and audit events after changes",
  },
  users: {
    description: "Manage accounts, roles, status, and password resets.",
    ...
    displayName: "Display name",
    password: "Password",
    passwordPlaceholder: "Leave blank to generate a temporary password",
    ...
    resources: "Resources",
    lastLogin: "Last Login",
    guideTitle: "Standard user flow",
    guideDescription: "Use this sequence before changing account access.",
    guideReviewIdentity: "Verify identity and account status",
    guideApplyLeastPrivilege: "Apply the smallest role change needed",
    guideVerifyAudit: "Confirm the result in user state and audit log",
  },
  sharing: {
    title: "Share",
    publicTarget: "Public",
    publicTargetDesc: "Anyone on the web can read this resource.",
    shareToWeb: "Share to Web",
    shareToTeam: "Share to Team",
    revokeShare: "Revoke Share",
    selectTeam: "Select a team",
    currentGrants: "Current access",
    noGrants: "No share grants yet.",
    teamTarget: "Team",
    userTarget: "User",
    readOnly: "Read only",
    publicShareNoticeTitle: "Public resources can be referenced",
    publicShareNotice: "Public resources may be read-only referenced by other users or teams.",
    publicConfirmTitle: "Share publicly?",
    ...
    guideDescription: "Confirm scope before sharing, then review current access after the change.",
    guideChooseTarget: "Choose public web access or a specific team",
    guideConfirmScope: "Confirm read-only scope and public reference behavior",
    guideReviewAccess: "Review current grants after saving or revoking",
  },
  auditLog: {
    title: "Audit Log",
    ...
    targetFilter: "Filter by target ID...",
  },
  home: {
    heroTitle: "Your AI-powered research assistant",
    heroSubtitle: "Upload sources, ask questions, generate notes and podcasts — all with complete control over your data and AI providers.",
    getStarted: "Get Started",
    createAccount: "Create Account",
    goToNotebooks: "My Notebooks",
    exploreNotebooks: "Explore Public Notebooks",
    exploreNotebooksDesc: "Discover research notebooks shared by the community",
  ...
  public: {
    ...
    notebooks: "Notebooks",
    sources: "Sources",
    noPublicNotebooks: "No public notebooks yet",
    noPublicNotebooksDesc: "When users share their notebooks publicly, they'll appear here.",
    noPublicSources: "No public sources yet",
    noPublicSourcesDesc: "When users share their sources publicly, they'll appear here.",
    mostVisited: "Most visited",
    mostReferenced: "Most referenced",
    views: "views",
    references: "references",
    discoverLimitHint: "Showing the top 20. Use search for more.",
  },
  visibility: {
    label: "Visibility",
    private: "Private",
  ...
  notebooks: {
    ...
    moveNotebook: "Move",
    moveNotebookTitle: "Move Notebook",
    moveNotebookDesc: "Move \"{name}\" into another workspace.",
    moveNotebookWarning: "After moving, this notebook will follow the target workspace permissions. Notes and chat sessions in this notebook move with it; sources stay linked and can be reviewed separately.",
    targetWorkspace: "Target workspace",
    selectWorkspace: "Select workspace",
    noManageableWorkspaces: "No other manageable workspaces are available.",
    moveNotebookSuccess: "Notebook moved successfully",
    failedToMoveNotebook: "Failed to move notebook",
    unarchive: "Unarchive",
  ...
  sources: {
    ...
    personalWorkspaceSources: "Personal workspace sources",
    ...
    bulkDeleteConfirm: "Are you sure you want to delete {count} source(s)? This action cannot be undone.",
    bulkDeleteSuccess: "Successfully deleted {count} source(s).",
    bulkDeletePartial: "Deleted {deleted} source(s), {failed} failed.",
    makePublicHint: "Click to make public",
    ...
    kgExtractQueued: "KG extraction queued",
    kgExtractHint: "Click to extract knowledge graph",
    embedded: "Embedded",
  ...
  settings: {
    ...
    workspaceSystemPolicy: "Workspace system limits",
    workspaceSystemPolicyDesc: "Set the maximum team workspace actions that any manager may enable. Disabled actions stay locked for every team.",
    workspaceSystemPolicyUpdated: "Workspace system limits updated.",
    failedToUpdateWorkspaceSystemPolicy: "Failed to update workspace system limits.",
    workspaceSystemPolicyUnavailable: "Workspace system limits are unavailable.",
    policyReadWorkspace: "Members can view workspaces",
    policyReadWorkspaceDesc: "Allow members to view resources inside shared team workspaces.",
    policyDeleteOwnSource: "Members can delete own sources",
    policyDeleteOwnSourceDesc: "Allow members to delete sources they added.",
    policyDeleteOwnChat: "Members can delete own chats",
    policyDeleteOwnChatDesc: "Allow members to delete chat sessions they created.",
