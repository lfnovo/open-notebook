...
export const frFR = {
  ...
  settings: {
    ...
    formulasEnabled: "Activer l'extraction de formules",
    formulasHelp: "Extrait les formules mathématiques des documents avec le moteur Docling. Traitement plus lent.",
    visionEnabled: "Activer l'enrichissement visuel",
    visionHelp: "Analyse les graphiques, images et diagrammes dans les documents avec le moteur Docling. Beaucoup plus lent et peut utiliser un modèle de vision.",
