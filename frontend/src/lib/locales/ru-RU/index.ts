...
export const ruRU = {
  ...
  chat: {
    ...
    selfExplainTitle: "Попробуйте самообъяснение",
    selfExplainDesc: "Объяснение материала своими словами — один из самых эффективных способов его усвоить: ИИ проверит ваше понимание и задаст уточняющие вопросы, а не просто ответит за вас.",
    selfExplainButton: "Начать самообъяснение",
    selfExplainPromptTemplate: "Я объясню эту тему своими словами. Укажите на любые ошибки или пропуски и задавайте мне уточняющие вопросы «почему» или «как», вместо того чтобы сразу давать ответ. Вот моё объяснение: ",
    quickPrompts: {
      triggerLabel: "Быстрые подсказки",
      dialogTitle: "Быстрые подсказки",
      dialogDescription: "Выберите начало разговора, заполните пару полей и проверьте перед отправкой.",
      backButton: "Назад",
      useButton: "Использовать этот запрос",
      templates: {
        interactiveQuiz: {
          title: "Интерактивная викторина",
          description: "Задаёт вопросы по одному и сразу оценивает каждый ответ, не раскрывая правильный ответ сразу.",
        },
        examSimulation: {
          title: "Симуляция экзамена",
          description: "Создаёт полный экзамен с несколькими вопросами и проверяет его, когда вы закончите отвечать.",
        },
        tutorPersona: {
          title: "Персональный репетитор",
          description: "Настраивает ИИ так, чтобы он выступал вашим репетитором по этому предмету на протяжении всего разговора.",
        },
        summaryContradictions: {
          title: "Резюме и противоречия",
          description: "Резюмирует источники этого блокнота и указывает на противоречия между ними.",
        },
      },
      fields: {
        topic: {
          label: "Тема",
          placeholder: "напр. Французская революция — оставьте пустым для всего содержимого",
        },
        questionCount: {
        ...
        subject: {
          label: "Предмет",
          placeholder: "напр. Клеточная биология, История XX века...",
        },
        style: {
          label: "Стиль",
        },
      ...
      options: {
        ...
        typeOpenEnded: "Вопросы с развёрнутым ответом",
        typeMixed: "Смешанный (множественный выбор и развёрнутые ответы)",
        styleFriendly: "Терпеливый и мотивирующий",
        styleStrict: "Строгий и требовательный",
        styleDirect: "Прямой и краткий",
      },
    },
  },
  searchPage: {
  ...
  usage: {
    costMeter: "Счётчик затрат",
    costMeterDesc: "Оценочные расходы на LLM за выбранный период",
    periodMonth: "Месяц",
    periodYear: "Год",
    loadError: "Не удалось загрузить данные об использовании",
    usedOfBudget: "из бюджета {{budget}}",
    percentUsed: "Использовано {{percent}}% бюджета",
    inputTokens: "Входные токены",
    outputTokens: "Выходные токены",
    byTaskType: "По типу задачи",
    noUsageYet: "Использование пока не зафиксировано",
  },
  study: {
    listTitle: "Учебные наборы",
    listDesc: "Карточки и тесты, созданные на основе ваших блокнотов",
    generateBtn: "Создать учебный набор",
    generateTitle: "Создать учебный набор",
    generateDesc: "Создайте карточки или тест на основе содержимого блокнота",
    notebookLabel: "Блокнот",
    notebookPlaceholder: "Выберите блокнот",
    interleavingHint: "Использует все источники и заметки блокнота — добавьте несколько разных тем перед генерацией, чтобы объединить их в одном наборе для изучения.",
    kindLabel: "Тип",
    kindFlashcards: "Карточки",
    kindQuiz: "Тест",
    nameLabel: "Название",
    namePlaceholder: "например, Повторение главы 3",
    itemCountLabel: "Количество элементов",
    modelLabel: "Модель",
    modelDefault: "По умолчанию",
    notebookRequired: "Требуется блокнот",
    notebookRequiredDesc: "Выберите блокнот для генерации",
    nameRequired: "Требуется название",
    nameRequiredDesc: "Дайте название этому учебному набору",
    generating: "Генерация...",
    generatingDesc: "Это может занять минуту в зависимости от модели и объёма контента",
    generationStarted: "Генерация запущена",
    generationSubmittedDesc: "Мы сообщим, когда \"{{name}}\" будет готов",
    generationComplete: "Учебный набор готов",
    generationCompleteDesc: "\"{{name}}\" готов к изучению",
    generationFailed: "Ошибка генерации",
    tryAgain: "Повторить",
    close: "Закрыть",
    noNotebooks: "Пока нет блокнотов",
    noNotebooksDesc: "Сначала создайте блокнот с каким-либо содержимым",
    loadingNotebooks: "Загрузка блокнотов...",
    loadingSets: "Загрузка учебных наборов...",
    loadErrorTitle: "Не удалось загрузить учебные наборы",
    loadErrorDesc: "Попробуйте ещё раз",
    noSetsYet: "Пока нет учебных наборов",
    noSetsYetDesc: "Сгенерируйте карточки или тест из любого блокнота, чтобы начать",
    total: "Всего",
    filterAll: "Все",
    itemsCount: "{{count}} элем.",
    view: "Просмотр",
    deleteSet: "Удалить",
    deleteSetTitle: "Удалить учебный набор",
    deleteSetDesc: "Вы уверены, что хотите удалить \"{{name}}\"? Это действие нельзя отменить.",
    deleteSuccess: "Учебный набор удалён",
    deleteFailed: "Не удалось удалить учебный набор",
    failedLabel: "Ошибка",
    backToList: "Назад к учебным наборам",
    createdOn: "Создано {{time}}",
    modelUsed: "Модель",
    notFound: "Учебный набор не найден",
    notFoundDesc: "Возможно, этот учебный набор был удалён.",
    flipCard: "Перевернуть",
    cardProgress: "Карточка {{current}} из {{total}}",
    previous: "Назад",
    question: "Вопрос {{current}} из {{total}}",
    grade: "Проверить тест",
    reset: "Сбросить",
    yourScore: "Ваш результат: {{score}}/{{total}}",
    correct: "Верно",
    incorrect: "Неверно",
    explanation: "Объяснение",
    exportAnki: "Экспорт в Anki (.csv)",
    filterDue: "К повторению",
    dueCount: "{{count}} к повторению",
    allCaughtUp: "Всё повторено",
    reviewPrompt: "Насколько хорошо вы это знали?",
    reviewAheadHint: "Эту карточку ещё не нужно было повторять — но повторение сейчас тоже засчитывается.",
    reviewFailed: "Не удалось сохранить результат повторения",
    rating: {
      again: "Ещё раз",
      hard: "Сложно",
      good: "Хорошо",
    ...
    guidedSession: {
      quickModeTab: "Быстрый режим",
      guidedModeTab: "Режим с ИИ-помощником",
      noCardsDue: "Сейчас нет карточек для повторения.",
      answerPlaceholder: "Введите ваш ответ...",
      submitAnswer: "Ответить",
      grading: "Оценка вашего ответа...",
      attemptLabel: "Попытка {{current}} из {{max}}",
      hintLabel: "Подсказка из вашей прошлой попытки",
      correctLabel: "Верно!",
      incorrectLabel: "Неверно",
      revealedAnswerLabel: "Ответ",
      tryAgainBtn: "Попробовать снова",
      nextCard: "Следующая карточка",
      sessionComplete: "Сессия завершена!",
      sessionSummary: "Вы освоили {{mastered}} из {{total}} карточек.",
      allMasteredMessage: "Готово! Можете переходить к следующему набору.",
      needsWorkTitle: "Карточки, требующие повторения",
  ...
  drive: {
    title: "Google Диск",
    description: "Подключите аккаунт Google Диска, чтобы импортировать файлы как источники",
    connect: "Подключить Google Диск",
    connectFailed: "Не удалось подключить Google Диск",
    connected: "Google Диск подключён",
    connectedAs: "Подключено как {{email}}",
    connectedNoEmail: "Подключено",
    notConnected: "Не подключено",
    disconnect: "Отключить",
    disconnected: "Google Диск отключён",
    disconnectFailed: "Не удалось отключить Google Диск",
    importFromDrive: "Импорт из Google Диска",
    importDialogDesc: "Выберите файл из подключённого Google Диска для импорта как источник",
    connectPromptDesc: "Подключите Google Диск в Настройках, чтобы импортировать из него файлы",
    goToSettings: "Перейти в Настройки",
    searchPlaceholder: "Поиск файлов на Диске...",
    filesLoadError: "Не удалось загрузить файлы Диска",
    noFilesFound: "Файлы не найдены",
    loadMore: "Загрузить ещё",
    import: "Импортировать",
    importFailed: "Не удалось импортировать файл из Диска",
  },
  settings: {
  ...
  models: {
    ...
    fallbackChainLabel: "Автоматическое переключение (по порядку)",
    fallbackChainEmpty: "Резервные модели не настроены. Если основная модель не сработает, запрос завершится ошибкой.",
    fallbackChainUnknownModel: "Неизвестная модель (удалена?)",
    fallbackChainMoveUp: "Переместить вверх",
    fallbackChainMoveDown: "Переместить вниз",
    fallbackChainRemove: "Удалить из резервной цепочки",
    fallbackChainAdd: "Добавить резервную модель",
  },
  apiKeys: {
  ...
  askSources: {
    triggerLabel: "Спросить по нескольким источникам",
    title: "Спросить сразу по нескольким источникам",
    description: "Выберите источники для объединения (включая целые книги) и задайте один вопрос — выполняется в фоне, поэтому никогда не зависает, а ответ сохраняется как заметка.",
    selectSourcesLabel: "Источники для включения",
    noSources: "В этой записной книжке пока нет источников.",
    questionLabel: "Ваш вопрос",
    questionPlaceholder: "Что говорят эти источники о...?",
    running: "Работаю над этим...",
    runningDesc: "С несколькими большими источниками это может занять чуть больше времени — ответ будет сохранён как заметка, когда будет готов.",
    failed: "При генерации ответа что-то пошло не так.",
    submitBtn: "Спросить",
    completeTitle: "Ответ сохранён",
    completeDesc: "Проверьте панель Заметок, чтобы увидеть ответ.",
    questionRequired: "Сначала напишите вопрос",
    selectAtLeastOne: "Выберите хотя бы один источник",
    submitError: "Не удалось начать запрос",
  },
