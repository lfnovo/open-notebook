...
export const jaJP = {
  ...
  usage: {
    costMeter: "コストメーター",
    costMeterDesc: "選択した期間のLLM推定利用料",
    periodMonth: "月",
    periodYear: "年",
    loadError: "利用状況データの読み込みに失敗しました",
    usedOfBudget: "/ 予算 {{budget}}",
    percentUsed: "予算の{{percent}}%を使用",
    inputTokens: "入力トークン数",
    outputTokens: "出力トークン数",
    byTaskType: "タスク種別ごと",
    noUsageYet: "まだ利用記録がありません",
  },
  study: {
    listTitle: "スタディセット",
    listDesc: "ノートブックから生成されたフラッシュカードとクイズ",
    generateBtn: "スタディセットを生成",
    generateTitle: "スタディセットを生成",
    generateDesc: "ノートブックの内容からフラッシュカードまたはクイズを作成します",
    notebookLabel: "ノートブック",
    notebookPlaceholder: "ノートブックを選択",
    interleavingHint: "ノートブック内のすべてのソースとノートを使用します — 生成前にいくつか異なるトピックを追加すると、1つの学習セットに混在させられます。",
    kindLabel: "種類",
    kindFlashcards: "フラッシュカード",
    kindQuiz: "クイズ",
    nameLabel: "名前",
    namePlaceholder: "例：第3章の復習",
    itemCountLabel: "項目数",
    modelLabel: "モデル",
    modelDefault: "デフォルト",
    notebookRequired: "ノートブックが必要です",
    notebookRequiredDesc: "生成元のノートブックを選択してください",
    nameRequired: "名前が必要です",
    nameRequiredDesc: "このスタディセットに名前を付けてください",
    generating: "生成中...",
    generatingDesc: "モデルとコンテンツの量によっては1分ほどかかることがあります",
    generationStarted: "生成を開始しました",
    generationSubmittedDesc: "「{{name}}」の準備ができたらお知らせします",
    generationComplete: "スタディセットの準備ができました",
    generationCompleteDesc: "「{{name}}」の学習を開始できます",
    generationFailed: "生成に失敗しました",
    tryAgain: "再試行",
    close: "閉じる",
    noNotebooks: "ノートブックがまだありません",
    noNotebooksDesc: "まずコンテンツのあるノートブックを作成してください",
    loadingNotebooks: "ノートブックを読み込み中...",
    loadingSets: "スタディセットを読み込み中...",
    loadErrorTitle: "スタディセットの読み込みに失敗しました",
    loadErrorDesc: "もう一度お試しください",
    noSetsYet: "スタディセットがまだありません",
    noSetsYetDesc: "ノートブックからフラッシュカードまたはクイズを生成して始めましょう",
    total: "合計",
    filterAll: "すべて",
    itemsCount: "{{count}} 件",
    view: "表示",
    deleteSet: "削除",
    deleteSetTitle: "スタディセットを削除",
    deleteSetDesc: "「{{name}}」を削除してもよろしいですか？この操作は取り消せません。",
    deleteSuccess: "スタディセットを削除しました",
    deleteFailed: "スタディセットの削除に失敗しました",
    failedLabel: "失敗",
    backToList: "スタディセット一覧に戻る",
    createdOn: "{{time}}に作成",
    modelUsed: "モデル",
    notFound: "スタディセットが見つかりません",
    notFoundDesc: "このスタディセットは削除された可能性があります。",
    flipCard: "裏返す",
    ...
    incorrect: "不正解",
    explanation: "解説",
    exportAnki: "Ankiにエクスポート (.csv)",
    filterDue: "復習予定",
    dueCount: "{{count}}件 復習予定",
    allCaughtUp: "すべて完了",
    reviewPrompt: "どのくらい覚えていましたか?",
    reviewAheadHint: "このカードはまだ復習予定ではありませんでしたが、今復習してもカウントされます。",
    reviewFailed: "復習結果を保存できませんでした",
    rating: {
      again: "もう一度",
      hard: "難しい",
      good: "できた",
    ...
    guidedSession: {
      quickModeTab: "クイックモード",
      guidedModeTab: "AIガイドモード",
      noCardsDue: "現在復習が必要なカードはありません。",
      answerPlaceholder: "答えを入力してください...",
      submitAnswer: "回答する",
      grading: "回答を評価しています...",
      attemptLabel: "{{max}}回中{{current}}回目",
      hintLabel: "前回の回答からのヒント",
      correctLabel: "正解!",
      incorrectLabel: "不正解",
      revealedAnswerLabel: "答え",
      tryAgainBtn: "もう一度挑戦",
      nextCard: "次のカード",
      sessionComplete: "セッション完了!",
      sessionSummary: "{{total}}枚中{{mastered}}枚を習得しました。",
      allMasteredMessage: "完了です!次のセットに進めます。",
      needsWorkTitle: "もっと復習が必要なカード",
      continueBtn: "続ける",
  ...
  drive: {
    title: "Google ドライブ",
    description: "Google ドライブ アカウントを接続してファイルをソースとしてインポート",
    connect: "Google ドライブに接続",
    connectFailed: "Google ドライブへの接続に失敗しました",
    connected: "Google ドライブが接続されました",
    connectedAs: "{{email}} として接続済み",
    connectedNoEmail: "接続済み",
    notConnected: "未接続",
    disconnect: "切断",
    disconnected: "Google ドライブを切断しました",
    disconnectFailed: "Google ドライブの切断に失敗しました",
    importFromDrive: "ドライブからインポート",
    importDialogDesc: "接続済みの Google ドライブからソースとしてインポートするファイルを選択してください",
    connectPromptDesc: "ファイルをインポートするには、設定で Google ドライブを接続してください",
    goToSettings: "設定に移動",
    searchPlaceholder: "ドライブのファイルを検索...",
    filesLoadError: "ドライブのファイルの読み込みに失敗しました",
    noFilesFound: "ファイルが見つかりません",
    loadMore: "もっと読み込む",
    import: "インポート",
    importFailed: "ドライブからのファイルのインポートに失敗しました",
  },
  settings: {
  ...
  models: {
    ...
    fallbackChainLabel: "自動フォールバック（順番通り）",
    fallbackChainEmpty: "フォールバックモデルが設定されていません。プライマリが失敗するとリクエストも失敗します。",
    fallbackChainUnknownModel: "不明なモデル（削除済み？）",
    fallbackChainMoveUp: "上へ移動",
    fallbackChainMoveDown: "下へ移動",
    fallbackChainRemove: "フォールバックチェーンから削除",
    fallbackChainAdd: "フォールバックモデルを追加",
  },
  apiKeys: {
  ...
  askSources: {
    triggerLabel: "複数のソースに質問",
    title: "複数のソースに一度に質問",
    description: "組み合わせるソースを選び(本一冊まるごとでも可)、質問を入力してください — バックグラウンドで実行されるためタイムアウトすることはなく、回答はノートとして保存されます。",
    selectSourcesLabel: "含めるソース",
    noSources: "このノートブックにはまだソースがありません。",
    questionLabel: "質問内容",
    questionPlaceholder: "これらのソースは...について何と言っていますか?",
    running: "処理中...",
    runningDesc: "大きなソースが複数あると少し時間がかかることがあります — 準備ができたら回答がノートとして保存されます。",
    failed: "回答の生成中に問題が発生しました。",
    submitBtn: "質問する",
    completeTitle: "回答を保存しました",
    completeDesc: "回答はノートパネルで確認できます。",
    questionRequired: "先に質問を入力してください",
    selectAtLeastOne: "少なくとも1つのソースを選択してください",
    submitError: "リクエストを開始できませんでした",
  },
