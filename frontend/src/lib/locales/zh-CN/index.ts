export const zhCN = {
  ...
  connectionErrors: {
    ...
    apiDesc: "无法访问 AgentBook API 服务器",
    dbTitle: "数据库连接失败",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "配置用于 AgentBook 不同用途的默认模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有这些模型，AgentBook 可能无法正常运行。",
  ...
  apiKeys: {
    ...
    description: "将 API 密钥安全地存储在数据库中，以在 AgentBook 中启用 AI 服务商。",
