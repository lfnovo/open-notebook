export const ptBR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do SAI Notebook não pôde ser alcançado",
    ...
    docLink: "Documentação do SAI Notebook",
  ...
  sources: {
    ...
    includeLinkedPages: "Incluir páginas vinculadas",
    includeLinkedPagesHint: "Analisar esta página em busca de links e escolher quais importar como fontes separadas",
    selectLinks: "Selecionar links",
    selectLinksDescription: "Escolha quais páginas vinculadas importar como fontes separadas",
    scanningLinks: "Procurando links na página…",
    linksFound: "{count} link(s) encontrado(s)",
    noLinksFound: "Nenhum link encontrado nesta página. Apenas a página original será importada.",
    selectAll: "Selecionar todos",
    selectNone: "Limpar seleção",
    selectSameDomain: "Selecionar do mesmo site",
    sameDomainBadge: "mesmo site",
    externalBadge: "externo",
    discoverLinksError: "Não foi possível analisar os links da página.",
    skipImportOriginal: "Pular — importar apenas a original",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o SAI Notebook exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do SAI Notebook está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no SAI Notebook",
    missingRequiredModels: "Modelos obrigatórios ausentes: {models}. O SAI Notebook pode não funcionar corretamente sem eles.",
  ...
  apiKeys: {
    ...
    description: "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no SAI Notebook.",
