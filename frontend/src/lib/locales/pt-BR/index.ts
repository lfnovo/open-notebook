export const ptBR = {
  ...
  apiErrors: {
    moduleNotFound: "Caderno não encontrado",
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do Backpack não pôde ser alcançado",
    ...
    docLink: "Documentação do Backpack",
  ...
  modules: {
    ...
    deleteModule: "Excluir Caderno",
    deleteModuleDesc: "Tem certeza que deseja excluir este caderno? Esta ação não pode ser desfeita.",
    activeModules: "Cadernos Ativos",
    archivedModules: "Cadernos Arquivados",
    emptyDescription: "Comece criando seu primeiro caderno para organizar sua pesquisa.",
    noActiveModules: "Nenhum caderno ativo",
    noArchivedModules: "Nenhum caderno arquivado",
  ...
  sources: {
    ...
    cannotSaveNoteNoModule: "Não é possível salvar nota: ID do caderno não disponível",
    ...
    sourcesAddedToModule: "{count} fonte(s) adicionada(s) ao caderno",
    failedToAddSourcesToModule: "Falha ao adicionar fontes ao caderno",
    partialAddSuccess: "{success} fonte(s) adicionada(s), {failed} falhou(aram)",
    sourceRemovedFromModule: "Fonte removida do caderno com sucesso",
    failedToRemoveSourceFromModule: "Falha ao remover fonte do caderno",
    ...
    manageModules: "Gerenciar Cadernos",
    manageModulesDesc: "Gerencie quais cadernos contêm esta fonte",
    noModulesAvailable: "Nenhum caderno disponível",
    loadFailed: "Falha ao carregar detalhes da fonte",
    removeFromModule: "Remover do Caderno",
    ...
    noModulesFound: "Nenhum caderno encontrado.",
  ...
  chat: {
    ...
    chatWithModule: "Conversar com Caderno",
  ...
  searchPage: {
    ...
    ask: "Perguntar",
    processing: "Processando...",
    saveToModules: "Salvar em Cadernos",
    ...
    notSet: "Não definido",
    saveToModule: "Salvar no Caderno",
    saveSuccess: "Salvo no caderno com sucesso",
    saveError: "Falha ao salvar no caderno",
    selectModule: "Selecionar Caderno",
    createNewModule: "Criar Novo Caderno",
    cancel: "Cancelar",
  ...
  podcasts: {
    ...
    loadingModules: "Carregando cadernos...",
    noModulesFoundInPodcasts: "Nenhum caderno encontrado. Crie um caderno e adicione conteúdo antes de gerar um podcast.",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o Backpack exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do Backpack está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    desc: "Configure modelos de IA para diferentes propósitos no Backpack",
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no Backpack",
    missingRequiredModels: "Modelos obrigatórios ausentes: {models}. O Backpack pode não funcionar corretamente sem eles.",
