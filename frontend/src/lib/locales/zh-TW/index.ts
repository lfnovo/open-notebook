export const zhTW = {
  ...
  modules: {
    ...
    unarchive: "取消封存",
    deleteModule: "刪除筆記本",
    deleteModuleDesc: "您確定要刪除此筆記本嗎？此操作無法復原。",
    activeModules: "活動中的筆記本",
    archivedModules: "封存的筆記本",
    emptyDescription: "從新增您的第一個筆記本開始，組織您的研究。",
    noActiveModules: "沒有活動中的筆記本",
    noArchivedModules: "沒有封存的筆記本",
    notFound: "未找到筆記本",
  ...
  sources: {
    ...
    cannotSaveNoteNoModule: "無法儲存筆記：缺少筆記本 ID",
    empty: "暫無來源",
    ...
    sourcesAddedToModule: "{count} 個來源已新增到筆記本",
    failedToAddSourcesToModule: "新增來源到筆記本失敗",
    partialAddSuccess: "{success} 個來源已新增，{failed} 個失敗",
    sourceRemovedFromModule: "來源已成功從筆記本中移除",
    failedToRemoveSourceFromModule: "從筆記本中移除來源失敗",
    ...
    sourceInsight: "來源見解",
    manageModules: "管理所屬筆記本",
    manageModulesDesc: "管理包含此來源的筆記本",
    noModulesAvailable: "暫無可用筆記本",
    deleteInsight: "刪除見解",
  ...
  podcasts: {
    ...
    tokens: "{count} token",
    chars: "{count} 字元",
    loadingModules: "正在載入筆記本...",
    noModulesFoundInPodcasts: "未找到筆記本。在生成播客之前，請先建立一個筆記本並新增內容。",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Backpack 的新版本可用。",
    upToDate: "已是最新",
    unknown: "未知",
  ...
  models: {
    title: "模型管理",
    desc: "設定用於 Backpack 不同用途的 AI 模型",
    ...
    defaultAssignmentsDesc: "設定用於 Backpack 不同用途的預設模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有這些模型，Backpack 可能無法正常運行。",
