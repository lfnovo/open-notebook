...
Before diving into how to use SAI Notebook, it's important to understand **how it thinks**. These core concepts explain the "why" behind the design.

## The Five Mental Models

### 1. [Notebooks, Sources, and Notes](notebooks-sources-notes.md)
How SAI Notebook organizes your research. Understand the three-tier container structure and how information flows from raw materials to finished insights.
...
How SAI Notebook makes AI aware of your research - two different approaches.
...
Why SAI Notebook has different interaction modes and when to use each one.
...
Why SAI Notebook can turn research into audio and why this matters.
...
- **You're new to SAI Notebook** — Start here to understand how the system works conceptually before learning the features
...
SAI Notebook is built on a simple insight: **Your research deserves to stay yours**.
