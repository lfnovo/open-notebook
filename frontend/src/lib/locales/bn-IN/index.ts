export const bnIN = {
  ...
  sources: {
    ...
    includeLinkedPages: "লিঙ্ক করা পৃষ্ঠা অন্তর্ভুক্ত করুন",
    includeLinkedPagesHint: "এই পৃষ্ঠার লিঙ্কগুলি স্ক্যান করুন এবং কোনগুলি আলাদা উৎস হিসেবে আমদানি করবেন তা বেছে নিন",
    selectLinks: "লিঙ্ক নির্বাচন করুন",
    selectLinksDescription: "কোন লিঙ্ক করা পৃষ্ঠাগুলি আলাদা উৎস হিসেবে আমদানি করবেন তা বেছে নিন",
    scanningLinks: "পৃষ্ঠায় লিঙ্ক খোঁজা হচ্ছে…",
    linksFound: "{count}টি লিঙ্ক পাওয়া গেছে",
    noLinksFound: "এই পৃষ্ঠায় কোনো লিঙ্ক পাওয়া যায়নি। শুধুমাত্র মূল পৃষ্ঠাটি আমদানি করা হবে।",
    selectAll: "সব নির্বাচন করুন",
    selectNone: "নির্বাচন বাতিল করুন",
    selectSameDomain: "একই সাইট নির্বাচন করুন",
    sameDomainBadge: "একই সাইট",
    externalBadge: "বাহ্যিক",
    discoverLinksError: "পৃষ্ঠার লিঙ্কগুলি স্ক্যান করা যায়নি।",
    skipImportOriginal: "এড়িয়ে যান — শুধু মূলটি আমদানি করুন",
  ...
  settings: {
    ...
    filesHelp: "একবার আপনার ফাইল আপলোড এবং প্রক্রিয়া হওয়ার পর, সেগুলি আর প্রয়োজন নেই। বেশিরভাগ ব্যবহারকারী SAI Notebook কে আপলোড ফোল্ডার থেকে আপলোড করা ফাইল স্বয়ংক্রিয়ভাবে মুছে ফেলার অনুমতি দিতে পারেন।",
  ...
  advanced: {
    ...
    updateAvailableDesc: "SAI Notebook এর একটি নতুন সংস্করণ উপলব্ধ।",
    upToDate: "আপ টু ডেট",
    unknown: "অজানা",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "SAI Notebook জুড়ে বিভিন্ন কাজের জন্য কোন মডেল ব্যবহার করব তা কনফিগার করুন",
    missingRequiredModels: "প্রয়োজনীয় মডেল অনুপস্থিত: {models}। এগুলি ছাড়া SAI Notebook সঠিকভাবে কাজ নাও করতে পারে।",
  ...
  apiKeys: {
    ...
    description: "SAI Notebook এ AI প্রোভাইডার সক্ষম করতে ডেটাবেসে নিরাপদভাবে API কী সংরক্ষণ করুন।",
