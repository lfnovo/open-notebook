...
- **[agent_book/CLAUDE.md](agent_book/CLAUDE.md)**: Backend core, domain models, LangGraph workflows, AI provisioning
- **[agent_book/domain/CLAUDE.md](agent_book/domain/CLAUDE.md)**: Data models, repository pattern, search functions
- **[agent_book/ai/CLAUDE.md](agent_book/ai/CLAUDE.md)**: ModelManager, AI provider integration, Esperanto usage
- **[agent_book/graphs/CLAUDE.md](agent_book/graphs/CLAUDE.md)**: LangGraph workflow design, state machines
- **[agent_book/database/CLAUDE.md](agent_book/database/CLAUDE.md)**: SurrealDB operations, migrations, async patterns
