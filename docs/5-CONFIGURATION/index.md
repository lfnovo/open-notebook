...
Configuration is how you customize SAI Notebook for your specific setup. This section covers what you need to know.
...
You will only use .env if you are running SAI Notebook locally.
...
```
1. Open SAI Notebook in your browser
