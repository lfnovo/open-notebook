...
export const zhTW = {
  ...
  usage: {
    costMeter: "費用計量",
    costMeterDesc: "所選期間內的預估 LLM 花費",
    periodMonth: "月",
    periodYear: "年",
    loadError: "載入使用資料失敗",
    usedOfBudget: "/ {{budget}} 預算",
    percentUsed: "已使用預算的 {{percent}}%",
  ...
  study: {
    listTitle: "學習集",
    listDesc: "根據你的筆記本生成的字卡與測驗",
    generateBtn: "產生學習集",
    generateTitle: "產生學習集",
    generateDesc: "根據筆記本內容建立字卡或測驗",
    notebookLabel: "筆記本",
    notebookPlaceholder: "選擇一個筆記本",
    interleavingHint: "會使用筆記本中的所有資料和筆記——生成前加入幾個不同的主題，即可在同一個學習集裡混合練習。",
    kindLabel: "類型",
    kindFlashcards: "字卡",
    kindQuiz: "測驗",
    nameLabel: "名稱",
    namePlaceholder: "例如：第 3 章複習",
    itemCountLabel: "項目數量",
    modelLabel: "模型",
    modelDefault: "預設",
    notebookRequired: "需要選擇筆記本",
    notebookRequiredDesc: "請選擇一個用於產生內容的筆記本",
    nameRequired: "需要名稱",
    nameRequiredDesc: "為此學習集命名",
    generating: "產生中...",
    generatingDesc: "依模型與內容大小，這可能需要一分鐘左右",
    generationStarted: "已開始產生",
    generationSubmittedDesc: "當「{{name}}」準備就緒時會通知你",
    generationComplete: "學習集已就緒",
    generationCompleteDesc: "「{{name}}」已可以開始學習",
    generationFailed: "產生失敗",
    tryAgain: "重試",
    close: "關閉",
    noNotebooks: "尚無筆記本",
    noNotebooksDesc: "請先建立一個包含內容的筆記本",
    loadingNotebooks: "正在載入筆記本...",
    loadingSets: "正在載入學習集...",
    loadErrorTitle: "載入學習集失敗",
    loadErrorDesc: "請重試",
    noSetsYet: "尚無學習集",
    noSetsYetDesc: "從任意筆記本產生字卡或測驗以開始使用",
    total: "總計",
    filterAll: "全部",
    itemsCount: "{{count}} 項",
    view: "檢視",
    deleteSet: "刪除",
    deleteSetTitle: "刪除學習集",
    deleteSetDesc: "確定要刪除「{{name}}」嗎？此操作無法復原。",
    deleteSuccess: "學習集已刪除",
    deleteFailed: "刪除學習集失敗",
    failedLabel: "失敗",
    backToList: "返回學習集列表",
    createdOn: "建立於 {{time}}",
    modelUsed: "模型",
    notFound: "找不到學習集",
    notFoundDesc: "此學習集可能已被刪除。",
    flipCard: "翻面",
    cardProgress: "第 {{current}} / {{total}} 張卡片",
    previous: "上一個",
    question: "第 {{current}} / {{total}} 題",
    grade: "批改測驗",
    reset: "重設",
    yourScore: "你的得分：{{score}}/{{total}}",
    correct: "正確",
    incorrect: "錯誤",
    explanation: "解析",
    exportAnki: "匯出為 Anki (.csv)",
    filterDue: "待複習",
    dueCount: "{{count}} 張待複習",
    allCaughtUp: "已全部複習",
    reviewPrompt: "你對這張卡片的掌握程度如何?",
    reviewAheadHint: "這張卡片還未到複習時間——現在複習仍然會被記錄。",
    reviewFailed: "儲存複習結果失敗",
    rating: {
      again: "重來",
      hard: "較難",
      good: "掌握",
    ...
    guidedSession: {
      quickModeTab: "快速模式",
      guidedModeTab: "AI 引導模式",
      noCardsDue: "目前沒有需要複習的卡片。",
      answerPlaceholder: "輸入你的答案...",
      submitAnswer: "回答",
      grading: "正在評估你的答案...",
      attemptLabel: "第 {{current}} 次嘗試(共 {{max}} 次)",
      hintLabel: "上次嘗試的提示",
      correctLabel: "正確!",
      incorrectLabel: "錯誤",
      revealedAnswerLabel: "答案",
      tryAgainBtn: "重試",
      nextCard: "下一張卡片",
      sessionComplete: "本次學習已完成!",
      sessionSummary: "你已掌握 {{total}} 張卡片中的 {{mastered}} 張。",
      allMasteredMessage: "太棒了!你可以繼續學習下一組。",
      needsWorkTitle: "需要加強複習的卡片",
      continueBtn: "繼續",
  ...
  drive: {
    title: "Google 雲端硬碟",
    description: "連接 Google 雲端硬碟帳戶以將檔案匯入為來源",
    connect: "連接 Google 雲端硬碟",
    connectFailed: "連接 Google 雲端硬碟失敗",
    connected: "Google 雲端硬碟已連接",
    connectedAs: "已連接為 {{email}}",
    connectedNoEmail: "已連接",
    notConnected: "未連接",
    disconnect: "中斷連接",
    disconnected: "Google 雲端硬碟已中斷連接",
    disconnectFailed: "中斷 Google 雲端硬碟連接失敗",
    importFromDrive: "從雲端硬碟匯入",
    importDialogDesc: "從已連接的 Google 雲端硬碟中選擇要匯入為來源的檔案",
    connectPromptDesc: "請在設定中連接 Google 雲端硬碟以匯入檔案",
    goToSettings: "前往設定",
    searchPlaceholder: "搜尋雲端硬碟檔案...",
    filesLoadError: "載入雲端硬碟檔案失敗",
    noFilesFound: "找不到檔案",
    loadMore: "載入更多",
    import: "匯入",
    importFailed: "從雲端硬碟匯入檔案失敗",
  },
  settings: {
  ...
  models: {
    ...
    fallbackChainLabel: "自動容錯備援（依序）",
    fallbackChainEmpty: "尚未設定備援模型。若主要模型失敗，請求將會失敗。",
    fallbackChainUnknownModel: "未知模型（已刪除？）",
    fallbackChainMoveUp: "上移",
    fallbackChainMoveDown: "下移",
    fallbackChainRemove: "從備援鏈中移除",
    fallbackChainAdd: "新增備援模型",
  },
  apiKeys: {
  ...
  askSources: {
    triggerLabel: "跨多個來源提問",
    title: "同時向多個來源提問",
    description: "選擇要合併的來源(包括整本書),提出一個問題——在背景執行,永遠不會逾時,答案會儲存為筆記。",
    selectSourcesLabel: "要包含的來源",
    noSources: "這個筆記本還沒有來源。",
    questionLabel: "你的問題",
    questionPlaceholder: "這些來源對...有什麼看法?",
    running: "正在處理...",
    runningDesc: "如果有多個大型來源可能需要更長時間——答案準備好後會儲存為筆記。",
    failed: "產生答案時出了點問題。",
    submitBtn: "提問",
    completeTitle: "答案已儲存",
    completeDesc: "查看筆記面板以取得答案。",
    questionRequired: "請先寫一個問題",
    selectAtLeastOne: "至少選擇一個來源",
    submitError: "無法啟動請求",
  },
