...
> - **[docker-compose-speaches.yml](../../examples/docker-compose-speaches.yml)** - Speaches + SAI Notebook
...
```yaml
# In your SAI Notebook docker-compose.yml
environment:
...
### Step 5: Add Model in SAI Notebook
...
### SAI Notebook in Docker (macOS/Windows)

**STT Base URL:** `http://host.docker.internal:8969/v1`

### SAI Notebook in Docker (Linux)
...
# From inside SAI Notebook container
