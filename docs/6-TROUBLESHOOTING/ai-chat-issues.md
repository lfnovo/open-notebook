...
# The model name in SAI Notebook must be EXACTLY "gemma3:12b"
...
> **Tip:** This error often occurs when you delete a model from Ollama but forget to update the default models in SAI Notebook. Always re-configure defaults after removing models.
