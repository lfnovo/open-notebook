export const jaJP = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Backpack APIサーバーに到達できませんでした",
  ...
  modules: {
    ...
    archive: "アーカイブ",
    unarchive: "アーカイブ解除",
    deleteModule: "ノートブックを削除",
    deleteModuleDesc: "このノートブックを削除しますか？この操作は元に戻せません。",
    activeModules: "アクティブなノートブック",
    archivedModules: "アーカイブ済みノートブック",
    emptyDescription: "最初のノートブックを作成してリサーチを整理しましょう。",
    noActiveModules: "アクティブなノートブックがありません",
    noArchivedModules: "アーカイブ済みノートブックがありません",
  ...
  sources: {
    ...
    cannotSaveNoteNoModule: "ノートを保存できません：ノートブックIDが利用できません",
    ...
    sourcesAddedToModule: "{count}件のソースをノートブックに追加しました",
    failedToAddSourcesToModule: "ノートブックへのソース追加に失敗しました",
    partialAddSuccess: "{success}件追加成功、{failed}件失敗",
    sourceRemovedFromModule: "ノートブックからソースを削除しました",
    failedToRemoveSourceFromModule: "ノートブックからのソース削除に失敗しました",
    ...
    manageModules: "ノートブックを管理",
    manageModulesDesc: "このソースを含むノートブックを管理",
    noModulesAvailable: "利用可能なノートブックがありません",
    loadFailed: "ソース詳細の読み込みに失敗しました",
    removeFromModule: "ノートブックから削除",
  ...
  searchPage: {
    ...
    notSet: "未設定",
    saveToModule: "ノートブックに保存",
    saveSuccess: "ノートブックに保存しました",
    saveError: "ノートブックへの保存に失敗しました",
    selectModule: "ノートブックを選択",
    createNewModule: "新規ノートブックを作成",
    cancel: "キャンセル",
    searchAndAsk: "検索と質問",
  ...
  podcasts: {
    ...
    tokens: "{count}トークン",
    chars: "{count}文字",
    loadingModules: "ノートブックを読み込み中...",
    noModulesFoundInPodcasts: "ノートブックが見つかりません。ポッドキャストを生成する前にノートブックを作成してコンテンツを追加してください。",
  ...
  settings: {
    ...
    filesHelp: "ファイルがアップロードされて処理されると、ファイル自体は不要になります。ほとんどのユーザーはBackpackがアップロードフォルダから自動的にファイルを削除することを許可すべきです。",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Backpackの新しいバージョンが利用可能です。",
    upToDate: "最新版です",
    unknown: "不明",
  ...
  models: {
    title: "モデル管理",
    desc: "Backpack全体で異なる目的に使用するAIモデルを設定",
    ...
    defaultAssignmentsDesc: "Backpack全体で異なる目的に使用するモデルを設定",
    missingRequiredModels: "必須モデルがありません: {models}。これらがないとBackpackが正しく機能しない可能性があります。",
