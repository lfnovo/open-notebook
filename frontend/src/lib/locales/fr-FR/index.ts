export const frFR = {
  ...
  questionPaper: {
    ...
    configureDesc: "Set topic, difficulty, and section structure for your exam paper",
    ...
    papersDesc: "Click a completed paper to view it",
    noPapers: "No papers generated yet. Use the Generate tab to create one.",
    selectedPaperTitle: "Paper Detail",
    selectPaperHint: "Select a completed paper from the list to view it",
    bankTitle: "Question Bank",
    bankDesc: "All approved questions are saved here for deduplication across sessions",
    ...
    bookSource: "Book / PDF Source (optional)",
    bookSourceDesc: "Upload a book or PDF to ground questions in its content. The LLM will only ask questions from that material.",
