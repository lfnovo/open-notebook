...
export const esES = {
  ...
  settings: {
    ...
    formulasEnabled: "Activar extracción de fórmulas",
    formulasHelp: "Extrae fórmulas matemáticas de documentos al usar el motor Docling. Más lento de procesar.",
    visionEnabled: "Activar enriquecimiento visual",
    visionHelp: "Analiza gráficos, imágenes y diagramas en documentos al usar el motor Docling. Significativamente más lento y puede llamar a un modelo de visión.",
