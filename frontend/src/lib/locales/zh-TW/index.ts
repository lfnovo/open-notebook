export const zhTW = {
  ...
  auth: {
    ...
    brandSlogan: "照亮探索之路 · 發現生命的無限可能",
    brandTagline: "Illuminating Discovery, Advancing Life.",
    loginIdentifierPlaceholder: "使用者名稱 / 電子郵件 / 研究者ID",
    rememberMe: "記住我",
    forgotPassword: "忘記密碼？",
    loginDivider: "或",
  ...
  externalApi: {
    description: "由系統管理員統一管理第三方來源、團隊授權和每月請求額度。",
    connectionOverview: "啟用連線",
    sourceOverview: "已設定來源",
    sourceOverviewDetail: "可授權給團隊使用",
    teamOverview: "工作區團隊",
    teamOverviewDetail: "授權目標",
    connections: "連線",
    connectionsDescription: "Endpoint、API key 和 API 目標由系統管理員一次性設定。",
    noConnections: "尚未設定第三方 API 連線。",
    noConnectionsHint: "先新增來源或輸出產物連線，再授權給團隊使用。",
    enabled: "啟用",
    disabled: "停用",
    keyStored: "金鑰已儲存",
    keyMissing: "缺少金鑰",
    ...
    testing: "測試中...",
    addConnection: "新增連線",
    addConnectionFor: "新增{target}連線",
    addSourceIntegration: "新增來源接入",
    addOutputIntegration: "新增輸出接入",
    endpointConfiguration: "Endpoint 設定",
    sourceDefinition: "來源定義",
    connectionNameHint: "使用清楚的供應商或插件名稱。",
    apiTarget: "API 目標",
    sourceApi: "來源",
    outputArtifactApi: "輸出產物",
    sourceApiDescription: "使用此 endpoint 查詢和取得連接來源。",
    outputApiDescription: "使用此 endpoint 生成輸出產物。",
    noSourceConnections: "請先建立目標為來源的連線。",
    baseUrl: "Base URL",
    apiKey: "API Key",
    timeoutSeconds: "逾時時間（秒）",
    timeoutValue: "{seconds} 秒逾時",
    sources: "來源",
    sourcesDescription: "來源使用目標為來源的連線，之後再授權給團隊使用。",
    noSources: "尚未設定第三方來源。",
    noSourcesHint: "從來源連線定義來源，然後授權給團隊。",
    addSource: "新增來源",
    sourceSetup: "來源設定",
    sourceSetupDescription: "定義來源能力，並為團隊設定額度授權。",
    grantSetupDescription: "將已設定來源授權給工作區團隊，並設定每月請求額度。",
    connection: "連線",
    ...
    noLinkedSource: "未定義來源",
    showDetails: "詳情",
    hideDetails: "收起",
    grantToTeam: "授權給團隊",
    authorizedTeams: "已授權團隊",
    noTeamGrants: "暫無團隊授權。",
    team: "團隊",
    selectSource: "選擇來源",
    selectTeam: "選擇團隊",
    monthlyRequestQuota: "每月請求額度",
    quotaValue: "每月額度 {quota}",
    grant: "授權",
    grantPrerequisite: "請先建立至少一個來源和一個工作區團隊，再進行授權。",
    allTeamsGranted: "所有工作區團隊均已授權。",
    lastTest: "最近測試",
    connectionSucceeded: "連線測試成功。",
    connectionFailed: "連線測試失敗。",
    testStatus: "測試狀態",
    healthResponse: "Health 返回",
    manifestResponse: "Manifest 返回",
    quotaUsage: "本月額度 {usage}",
    switchToTeamWorkspace: "切換到團隊工作區後可使用已授權的第三方來源。",
    noAuthorizedSources: "此團隊尚無已授權的第三方來源。",
    searchPlaceholder: "搜尋第三方來源",
    searchAction: "搜尋第三方來源",
    waitingForResults: "正在等待結果返回...",
    joining: "正在加入來源...",
    noResults: "未返回結果。",
    join: "加入",
    joinFailed: "加入來源失敗。",
    connectedSource: "深度檢索",
    connectedSourceDescription: "搜尋已授權的第三方來源，然後將結果加入為來源。",
    targetNotebook: "目標筆記本",
    selectTargetNotebook: "選擇目標筆記本",
    selectTargetNotebookFirst: "請先選擇目標筆記本，再使用深度檢索。",
    fetch: "取得",
    reference: "引用",
    snapshot: "快照",
  },
  profile: {
    title: "個人資料",
    description: "管理你的顯示名稱、偏好設定和密碼。",
    loadFailed: "載入個人資料失敗。",
    saved: "個人資料已儲存。",
    completeTitle: "驗證電子郵件後繼續",
    completeDescription: "填寫此帳號使用的電子郵件，並設定電子郵件登入密碼。",
    passwordBindingHint: "如果電子郵件已註冊，驗證後會把微信綁定到原帳號，不會修改原帳號密碼。",
    username: "使用者名稱",
    email: "電子郵件",
  ...
  teams: {
    ...
    modelDefaults: "團隊預設模型",
    modelDefaultsDesc: "從系統管理員授權的可用模型中選擇此團隊的預設模型。留空時繼承一般使用者的系統預設模型。",
    inheritSystemDefault: "繼承系統預設",
    clearTeamDefault: "清空團隊預設",
    noTeamModelsAvailable: "系統管理員尚未為此團隊配置可用模型。",
    modelDefaultsSaved: "團隊預設模型已更新。",
    allowedModels: "可用模型",
    allowedModelsDesc: "選擇此團隊可以使用的已配置模型。",
    allowedTransformations: "可用轉換",
    allowedTransformationsDesc: "選擇此團隊可以使用的已配置轉換。",
    noModelsAvailable: "暫無可用模型。",
    noTransformationsAvailable: "暫無可用轉換。",
    allowlistSaved: "團隊可用範圍已更新。",
    workspacePolicy: "工作區權限",
    workspacePolicyDesc: "配置成員在此團隊工作區中可以執行的操作。系統上限仍可能鎖定部分操作。",
    workspacePolicyUpdated: "工作區權限已更新。",
    failedToUpdateWorkspacePolicy: "更新工作區權限失敗。",
    noWorkspacePolicy: "未找到此團隊對應的工作區。",
    policyLockedBySystem: "已被系統策略停用。",
    policyCreateSource: "成員可以新增來源",
    policyCreateSourceDesc: "允許成員向團隊筆記本新增來源。",
    policyUpdateOwnSource: "成員可以編輯自己的來源",
    policyUpdateOwnSourceDesc: "允許成員更新自己新增的來源。",
    policyProcessOwnSource: "成員可以處理自己的來源",
    policyProcessOwnSourceDesc: "允許成員對自己新增的來源重試處理並生成衍生內容。",
    policyRemoveSource: "成員可以移除來源",
    policyRemoveSourceDesc: "允許成員從團隊筆記本移除來源。",
    policyCreateNote: "成員可以新增筆記",
    policyCreateNoteDesc: "允許成員向團隊筆記本新增筆記。",
    policyUpdateOwnNote: "成員可以編輯自己的筆記",
    policyUpdateOwnNoteDesc: "允許成員編輯自己建立的筆記。",
    policyDeleteOwnNote: "成員可以刪除自己的筆記",
    policyDeleteOwnNoteDesc: "允許成員刪除自己建立的筆記。",
    policyUpdateNotebook: "成員可以編輯自己的筆記本",
    policyUpdateNotebookDesc: "允許成員編輯自己建立的筆記本元資訊。",
    guideTitle: "團隊標準流程",
    guideDescription: "按此順序維護團隊成員和資源存取，避免權限含義變得混亂。",
    guideCreateTeam: "建立或選擇正確團隊",
    guideAssignMembers: "為成員分配最小必要角色",
    guideReviewShares: "變更後回看分享授權和審計事件",
  },
  users: {
    description: "管理帳號、角色、狀態和密碼重設。",
    empty: "暫無使用者。",
    user: "使用者",
    users: "使用者",
    username: "使用者名稱",
    ...
    lastLogin: "最近登入",
    guideTitle: "使用者標準流程",
    guideDescription: "修改帳號存取前，按此順序完成確認、變更和回看。",
    guideReviewIdentity: "確認身分和帳號狀態",
    guideApplyLeastPrivilege: "只套用必要的最小角色變更",
    guideVerifyAudit: "透過使用者狀態和審計日誌確認結果",
  },
  sharing: {
    title: "Share",
    publicTarget: "Public",
    ...
    guideTitle: "安全分享流程",
    guideDescription: "分享前確認範圍，儲存或撤回後回看目前授權。",
    guideChooseTarget: "選擇全網公開或指定團隊",
    guideConfirmScope: "確認唯讀範圍和公開引用行為",
    guideReviewAccess: "儲存或撤回後檢查目前存取權限",
  },
  auditLog: {
    title: "Audit Log",
  ...
  notebooks: {
    ...
    actions: "筆記本操作",
    moveNotebook: "移動",
    moveNotebookTitle: "移動筆記本",
    moveNotebookDesc: "將「{name}」移動到另一個工作區。",
    moveNotebookWarning: "移動後，此筆記本將遵循目標工作區權限。筆記本中的筆記和對話會一併移動；來源會繼續保持引用，後續可單獨檢查。",
    targetWorkspace: "目標工作區",
    selectWorkspace: "選擇工作區",
    noManageableWorkspaces: "沒有其它可管理的工作區。",
    moveNotebookSuccess: "筆記本移動成功",
    failedToMoveNotebook: "移動筆記本失敗",
    unarchive: "取消封存",
    ...
    personalNotebooks: "個人筆記本",
    teamNotebooks: "團隊筆記本",
    publicNotebooks: "公開筆記本",
  ...
  settings: {
    ...
    loadFailed: "載入設定失敗",
    workspaceSystemPolicy: "工作區系統上限",
    workspaceSystemPolicyDesc: "設定所有團隊工作區可開放給成員的最高權限。關閉的操作會對所有團隊保持鎖定。",
    workspaceSystemPolicyUpdated: "工作區系統上限已更新。",
    failedToUpdateWorkspaceSystemPolicy: "更新工作區系統上限失敗。",
    workspaceSystemPolicyUnavailable: "工作區系統上限暫不可用。",
    policyReadWorkspace: "成員可以查看工作區",
    policyReadWorkspaceDesc: "允許成員查看共享團隊工作區內的資源。",
    policyDeleteOwnSource: "成員可以刪除自己的來源",
    policyDeleteOwnSourceDesc: "允許成員刪除自己新增的來源。",
    policyDeleteOwnChat: "成員可以刪除自己的對話",
    policyDeleteOwnChatDesc: "允許成員刪除自己建立的對話。",
