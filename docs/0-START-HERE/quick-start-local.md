...
Get SAI Notebook running with **100% local AI** using Ollama. No cloud API keys needed, completely private.
...
## Step 5: Access SAI Notebook (instant)
...
4. In SAI Notebook, go to **Settings** → **API Keys**
