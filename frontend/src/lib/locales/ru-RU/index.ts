export const ruRU = {
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер SAI Notebook недоступен",
    ...
    docLink: "Документация SAI Notebook",
  ...
  sources: {
    ...
    includeLinkedPages: "Включить связанные страницы",
    includeLinkedPagesHint: "Просканировать эту страницу на наличие ссылок и выбрать, какие импортировать как отдельные источники",
    selectLinks: "Выбрать ссылки",
    selectLinksDescription: "Выберите, какие связанные страницы импортировать как отдельные источники",
    scanningLinks: "Поиск ссылок на странице…",
    linksFound: "Найдено ссылок: {count}",
    noLinksFound: "На этой странице ссылки не найдены. Будет импортирована только исходная страница.",
    selectAll: "Выбрать все",
    selectNone: "Снять выбор",
    selectSameDomain: "Выбрать с того же сайта",
    sameDomainBadge: "тот же сайт",
    externalBadge: "внешняя",
    discoverLinksError: "Не удалось просканировать ссылки на странице.",
    skipImportOriginal: "Пропустить — импортировать только оригинал",
  ...
  settings: {
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить SAI Notebook автоматически удалять загруженные файлы из папки загрузок.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия SAI Notebook.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в SAI Notebook",
    missingRequiredModels: "Отсутствуют необходимые модели: {models}. SAI Notebook может работать некорректно без них.",
  ...
  apiKeys: {
    ...
    description: "Храните API-ключи в базе данных для безопасного подключения провайдеров ИИ в SAI Notebook.",
