export const zhTW = {
  ...
  connectionErrors: {
    ...
    apiDesc: "無法存取 AgentBook API 伺服器",
    dbTitle: "資料庫連線失敗",
  ...
  advanced: {
    ...
    updateAvailableDesc: "AgentBook 的新版本可用。",
    upToDate: "已是最新",
    unknown: "未知",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "設定用於 AgentBook 不同用途的預設模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有這些模型，AgentBook 可能無法正常運行。",
  ...
  apiKeys: {
    ...
    description: "將 API 金鑰安全地儲存在資料庫中，以在 AgentBook 中啟用 AI 服務商。",
