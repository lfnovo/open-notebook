...
export const ptBR = {
  ...
  settings: {
    ...
    formulasEnabled: "Ativar extração de fórmulas",
    formulasHelp: "Extrai fórmulas matemáticas de documentos ao usar o mecanismo Docling. Mais lento para processar.",
    visionEnabled: "Ativar enriquecimento visual",
    visionHelp: "Analisa gráficos, imagens e diagramas em documentos ao usar o mecanismo Docling. Significativamente mais lento e pode chamar um modelo de visão.",
