export const ruRU = {
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер AgentBook недоступен",
    ...
    docLink: "Документация AgentBook",
  ...
  settings: {
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить AgentBook автоматически удалять загруженные файлы из папки загрузок.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия AgentBook.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в AgentBook",
    missingRequiredModels: "Отсутствуют необходимые модели: {models}. AgentBook может работать некорректно без них.",
  ...
  apiKeys: {
    ...
    description: "Храните API-ключи в базе данных для безопасного подключения провайдеров ИИ в AgentBook.",
