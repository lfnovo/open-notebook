...
| `SURREAL_NAMESPACE` | Yes | agent_book | SurrealDB namespace |
| `SURREAL_DATABASE` | Yes | agent_book | SurrealDB database name |
...
- **Case-sensitive:** `OPEN_NOTEBOOK_ENCRYPTION_KEY` ≠ `agent_book_encryption_key`
