...
def get_transformation_details(transformation_id):
    try:
        ...
        transformation_data = json.loads(transformation.model_dump_json())
        
        print(json.dumps(transformation_data))
        sys.stdout.flush()
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        get_transformation_details(transformation_id)
    else:
