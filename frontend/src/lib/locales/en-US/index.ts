export const enUS = {
  ...
  questionPaper: {
    ...
    subtitle: "Generate structured exam papers with multi-agent AI quality review",
    generateTab: "Generate",
    papersTab: "History",
    bankTab: "Question Bank",
    configureTitle: "Configure Paper",
    configureDesc: "Set grade, learning material, and the Chapter × Difficulty blueprint",
    grade: "Grade",
    subject: "Subject",
    language: "Language",
    totalQuestions: "Total Questions",
    passPercentage: "Pass Percentage",
    chapterBlueprint: "Chapter × Difficulty Blueprint",
    answerTypeBlueprint: "Answer Type by Difficulty",
    chapter: "Chapter",
    total: "Total",
    difficult: "Difficult",
    ...
    optionsFormatLocked: "Options = 5 (A–E) · Format = MCQ. These are fixed for this workflow.",
    targetDifficulty: "Target",
    validatedDifficulty: "Validated",
    cognitiveScore: "Cognitive score",
    validationStatus: "Validation",
    auditFailedTitle: "Paper did not pass the blueprint audit",
    failedSlotsTitle: "Slots needing manual review",
    chapterCountMismatch: "This blueprint requires exactly {required} chapters, but {selected} are selected. Chapters are not merged or dropped. Select {required} chapters, or change the blueprint table to match.",
    topicOnlyHint: "Without a book, questions are generated from the subject/topic. Blueprint chapter rows are labels only — this does not require uploaded learning material.",
    resultTitle: "Generated Paper",
    resultEmpty: "Configure and generate a paper to see the result here",
    topic: "Topic",
    topicPlaceholder: "e.g., Mutual Funds — NFO Basics",
    difficulty: "Difficulty",
    easy: "Easy",
    medium: "Medium",
    hard: "Hard",
    targetMarks: "Total Marks",
    sections: "Sections",
    sectionsDesc: "Define the question types and counts for each section",
    questionsTotal: "questions total",
    questions: "questions",
    selectType: "Select question type...",
    objectives: "Curriculum Objectives",
    objectivesDesc: "One objective per line. Used for coverage audit after generation.",
    objectivesPlaceholder: "Understand the definition of an NFO\nExplain the subscription process\nDifferentiate open-ended and close-ended funds",
    generate: "Generate Paper",
    generating: "Generating...",
    generationStarted: "Paper generation started",
    generationFailed: "Paper generation failed",
    status: "Status",
    marks: "marks",
    section: "Section",
    download: "Download",
    questionPaperTab: "Question Paper",
    answerKeyTab: "Answer Key",
    noQuestions: "No questions assembled",
    noAnswerKey: "No answer key generated",
    coverageGapsTitle: "Curriculum Coverage Gaps",
    coveredTopicsTitle: "Topics Covered",
    answer: "Answer",
    papersTitle: "Generated Papers",
    papersDesc: "Filter and open a paper. Technical errors are shown in the detail panel.",
    noPapers: "No papers generated yet. Use the Generate tab to create one.",
    selectedPaperTitle: "Paper Detail",
    selectPaperHint: "Select a paper from the list to view it",
    statusCompleted: "Completed",
    ...
    historyColName: "Paper",
    historyColQuestions: "Questions Generated",
    historyColDifficultyMix: "Difficulty Mix",
    historyFilterDifficulty: "Difficulty",
    difficultyEasyOnly: "Easy Only",
    difficultyMediumOnly: "Medium Only",
    difficultyDifficultOnly: "Difficult Only",
    difficultyMixed: "Mixed",
    difficultyBreakdown: "Difficulty Breakdown",
    requestedDifficulty: "Requested",
    generatedDifficulty: "Generated",
    remainingDifficulty: "Remaining",
    requestedQuestions: "Requested Questions",
    ...
    bankDesc: "Review stored questions. Filter by Grade, Year, Book, Chapter, Difficulty, or Batch ID. Download exports the current filter only.",
    year: "Year",
    yearPlaceholder: "e.g. 2026",
    gradePlaceholder: "e.g. 9",
    subjectPlaceholder: "e.g. Financial Literacy",
    bookName: "Book name",
    bookNamePlaceholder: "e.g. NFO Practice Book",
    editionOptional: "Edition / version (optional)",
    displayName: "Display name",
    displayNameHint: "Suggested format: Book name Year - Grade X",
    bookFile: "PDF or file",
    saveBook: "Save book",
    bookSaved: "Book saved. You can reuse it without uploading again.",
    uploadNewBook: "+ Upload New Book",
    uploadNewBookTitle: "Upload new book",
    uploadNewBookDesc: "Save the book once. Later papers can pick it from the library by Grade, Year, and Book.",
    libraryHint: "Pick a saved book. Upload only if this book is not already in the library.",
    selectGradeFirst: "Enter Grade first",
    selectYear: "Select year",
    yearNotSet: "Year not set",
    storedBook: "Book",
    selectBook: "Select book",
    selectBookRequired: "Select a book",
    loadingBooks: "Loading saved books…",
    noBooksForGrade: "No saved books for this grade. Upload a new book to add one.",
    missingBookMetadata: "Missing details for this saved book: {fields}. The original book was kept as-is.",
    missingBookDetails: "Missing book details",
    editBookDetails: "Edit book details",
    editBookDetailsTitle: "Edit book details",
    editBookDetailsDesc: "Update the name shown in the library. This does not replace the saved book or its questions.",
    saveDetails: "Save details",
    bookDetailsSaved: "Book details saved",
    bookDetailsSaveFailed: "Could not save book details",
    loadingChapters: "Loading chapters…",
    bankSearchPlaceholder: "Search questions by topic or keyword...",
    bankNoResults: "No questions match your search",
    bankEmpty: "No questions in the bank yet. Generate a paper to populate it.",
    bankQuestionCount: "questions",
    bankSummaryTotal: "Total Questions",
    bankFilterBook: "Book",
    bankFilterAnswerType: "Answer Type",
    bankFilterSearch: "Search",
    bankFilterReset: "Reset",
    bankFilterBatch: "Batch ID",
    bankDownloadExcel: "Download Excel",
    bankDownloadEmpty: "No questions to download",
    bankDownloadFailed: "Failed to download Excel",
    filterAll: "All",
    bankColQuestion: "Question",
    bankColView: "View",
    bankDetailTitle: "Question Detail",
    bankDetailSubTopic: "Sub-topic",
    bankDetailBatchId: "Batch ID",
    explanation: "Explanation",
    bookSource: "Saved book (optional)",
    bookSourceDesc: "Choose a saved book by Grade, Year, and Book. Upload a new book only when it is not already saved.",
    bookUploadPrompt: "Click to upload a book or PDF",
    bookExtracting: "Extracting text and detecting chapters...",
    bookUploaded: "{count} chapters detected",
    bookUploadFailed: "Failed to process the uploaded file",
    bookGrounded: "Questions will be generated from the uploaded book content",
    chapters: "chapters",
    selectChapters: "Select chapters to include",
    selectAll: "Select all",
    deselectAll: "Deselect all",
    allChaptersSelected: "All chapters selected — entire book will be used",
    chaptersSelected: "{count} of {total} chapters selected",
    noChaptersSelected: "No chapters selected — please select at least one",
    gradeMismatchWarning: "Selected grade: {selected} — Uploaded learning material appears to be Grade {detected}. Please confirm before generating.",
    regenerateMissing: "Regenerate {count} Missing Question(s)",
    regenerating: "Regenerating {count} missing question(s)...",
    questionsCouldNotFinalize: "{count} question(s) could not be finalized",
    regenerateSuccess: "Regeneration complete",
    regenerateFailed: "Regeneration failed",
    bankGenerateTitle: "Generate Bank Questions",
    bankGenerateDesc: "Create questions for one grade, book, chapter, and difficulty. Accepted questions are saved to the Question Bank.",
    bankGenerate: "Generate Bank Questions",
    bankGenerating: "Generating bank questions...",
    bankGenerateStarted: "Bank generation started",
    bankGenerateFailed: "Bank generation failed",
    bankGenerateSuccess: "Bank generation complete: {accepted} of {requested} questions accepted",
    bankGeneratePartial: "Bank generation finished with {accepted} of {requested} questions accepted",
    bankSelectGrade: "Select Grade",
    bankSelectYear: "Select Year",
    bankSelectBook: "Select Book",
    bankSelectChapter: "Select Chapter",
    bankSelectDifficulty: "Select Difficulty",
    bankSelectAnswerType: "Select Answer Type",
    bankSelectBatch: "Select Batch ID",
    bankNoChapters: "No chapters found for this book",
    bankCountMismatch: "Single Correct + Multiple Correct must equal Total Questions ({total}). Current sum is {sum}.",
    bankAccepted: "Accepted",
    bankFailedCount: "Failed",
    bankRequested: "Requested",
    bankGenerateHint: "This adds questions to the bank. It does not create a final exam paper.",
    bankHistoryTitle: "Bank Generation History",
    bankHistoryDesc: "Previous Question Bank batch jobs. View accepted questions or export Excel for a batch.",
    bankHistoryEmpty: "No bank generation jobs yet.",
    bankHistoryColBatchId: "Batch ID",
    bankHistoryViewQuestions: "View questions",
    bankHistoryNoQuestions: "No accepted questions in this batch.",
    bankHistoryLoadFailed: "Could not load batch questions.",
    bankHistoryQuestionsTitle: "Generated questions",
    bankElapsed: "Elapsed",
    bankRemaining: "Remaining",
    bankFailedAttempts: "Failed attempts",
    bankStatusStarting: "Starting…",
    bankProgressRunningHint: "Accepted count updates as questions pass validation.",
    bankProgressCompleteHint: "All requested questions were accepted.",
    bankProgressPartialHint: "{accepted} of {requested} questions were accepted.",
    bankStatusPartial: "Completed (partial)",
    bankStopReason: "Stop reason",
    bankReviewTitle: "Review Bank Questions",
    bankReviewBack: "Back to history",
    bankReviewOptions: "Options",
    bankReviewCorrectOption: "Correct",
    bankReviewQuestionN: "Question {n}",
    bankQuestionType: "Question type",
    bankCorrectAnswer: "Correct answer",
  },
}
