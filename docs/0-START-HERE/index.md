# SAI Notebook - Start Here

**SAI Notebook** is a privacy-focused AI research assistant. Upload documents, chat with AI, generate notes, and create podcasts—all with complete control over your data.
...
| Feature | SAI Notebook | Notebook LM |
|---------|---|---|
