export const enUS = {
  ...
  settings: {
    ...
    formulasEnabled: "Enable Formula Extraction",
    formulasHelp: "Extract mathematical formulas from documents when using the Docling engine. Slower to process.",
    visionEnabled: "Enable Vision Enrichment",
    visionHelp: "Analyze charts, images, and diagrams in documents when using the Docling engine. Significantly slower and may call a vision model.",
