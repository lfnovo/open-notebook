...
export const frFR = {
  ...
  settings: {
    ...
    enableCrawl4aiHint: "Crawl4AI local est facultatif. Activez-le avec OPEN_NOTEBOOK_ENABLE_CRAWL4AI=true (installé au premier démarrage), ou définissez CRAWL4AI_API_URL pour utiliser un serveur distant.",
