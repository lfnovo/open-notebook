export const itIT = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di AgentBook non è raggiungibile",
    ...
    docLink: "Documentazione AgentBook",
  ...
  settings: {
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a AgentBook di eliminare automaticamente i file caricati dalla cartella upload.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "È disponibile una nuova versione di AgentBook.",
    upToDate: "Aggiornato",
    unknown: "Sconosciuto",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in AgentBook",
    missingRequiredModels: "Modelli richiesti mancanti: {models}. AgentBook potrebbe non funzionare correttamente senza questi.",
  ...
  apiKeys: {
    ...
    description: "Salva le chiavi API in modo sicuro nel database per abilitare i provider IA in AgentBook.",
