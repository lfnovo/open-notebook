...
export const esES = {
  ...
  chat: {
    ...
    selfExplainTitle: "Prueba la autoexplicación",
    selfExplainDesc: "Explicar el material con tus propias palabras es una de las formas más efectivas de aprenderlo — la IA comprobará tu comprensión y te hará preguntas de seguimiento en lugar de responder por ti.",
    selfExplainButton: "Iniciar autoexplicación",
    selfExplainPromptTemplate: "Voy a explicar este tema con mis propias palabras. Señala cualquier error u omisión, y hazme preguntas de seguimiento tipo \"por qué\" o \"cómo\" en lugar de darme la respuesta directamente. Aquí va mi explicación: ",
    quickPrompts: {
      triggerLabel: "Prompts rápidos",
      dialogTitle: "Prompts rápidos",
      dialogDescription: "Elige un punto de partida para la conversación, completa un par de datos y revísalo antes de enviarlo.",
      backButton: "Atrás",
      useButton: "Usar este prompt",
      templates: {
        interactiveQuiz: {
          title: "Quiz interactivo",
          description: "Te hace preguntas una por una y califica cada respuesta al momento, sin revelarte la respuesta correcta de inmediato.",
        },
        examSimulation: {
          title: "Simulación de examen",
          description: "Genera un examen completo con varias preguntas y lo corrige cuando termines de responder.",
        },
        tutorPersona: {
          title: "Tutor personalizado",
          description: "Configura a la IA para que actúe como tu tutor de esta materia durante toda la conversación.",
        },
        summaryContradictions: {
          title: "Resumen y contradicciones",
          description: "Resume las fuentes de este notebook y señala si hay contradicciones entre ellas.",
        },
      },
      fields: {
        topic: {
          label: "Tema",
          placeholder: "ej. la Revolución Francesa — déjalo vacío para todo el contenido",
        },
        questionCount: {
      ...
      options: {
        ...
        typeOpenEnded: "Preguntas de desarrollo",
        typeMixed: "Mixto (opción múltiple y desarrollo)",
        styleFriendly: "Paciente y motivador",
        styleStrict: "Estricto y exigente",
        styleDirect: "Directo y breve",
      },
    },
  },
  searchPage: {
  ...
  usage: {
    costMeter: "Medidor de Coste",
    costMeterDesc: "Gasto estimado de LLM para el período seleccionado",
    periodMonth: "Mes",
    periodYear: "Año",
    loadError: "No se pudieron cargar los datos de uso",
    usedOfBudget: "de {{budget}} de presupuesto",
    percentUsed: "{{percent}}% del presupuesto utilizado",
    inputTokens: "Tokens de entrada",
    outputTokens: "Tokens de salida",
    byTaskType: "Por tipo de tarea",
    noUsageYet: "Aún no hay uso registrado",
  },
  study: {
    listTitle: "Conjuntos de Estudio",
    listDesc: "Tarjetas y cuestionarios generados a partir de tus cuadernos",
    generateBtn: "Generar Conjunto de Estudio",
    generateTitle: "Generar Conjunto de Estudio",
    generateDesc: "Crea tarjetas o un cuestionario a partir del contenido de un cuaderno",
    notebookLabel: "Cuaderno",
    notebookPlaceholder: "Selecciona un cuaderno",
    interleavingHint: "Se basa en todas las fuentes y notas del cuaderno — añade varios temas distintos antes de generar para combinarlos en un mismo set de estudio.",
    kindLabel: "Tipo",
    kindFlashcards: "Tarjetas",
    kindQuiz: "Cuestionario",
    nameLabel: "Nombre",
    namePlaceholder: "p. ej., Repaso del Capítulo 3",
    itemCountLabel: "Número de elementos",
    modelLabel: "Modelo",
    modelDefault: "Predeterminado",
    notebookRequired: "Cuaderno obligatorio",
    notebookRequiredDesc: "Selecciona un cuaderno para generar el contenido",
    nameRequired: "Nombre obligatorio",
    nameRequiredDesc: "Ponle un nombre a este conjunto de estudio",
    generating: "Generando...",
    generatingDesc: "Esto puede tardar un minuto según el modelo y el tamaño del contenido",
    generationStarted: "Generación iniciada",
    generationSubmittedDesc: "Te avisaremos cuando \"{{name}}\" esté listo",
    generationComplete: "Conjunto de estudio listo",
    generationCompleteDesc: "\"{{name}}\" ya está listo para estudiar",
    generationFailed: "Error en la generación",
    tryAgain: "Intentar de Nuevo",
    close: "Cerrar",
    noNotebooks: "Todavía no hay cuadernos",
    noNotebooksDesc: "Primero crea un cuaderno con algo de contenido",
    loadingNotebooks: "Cargando cuadernos...",
    loadingSets: "Cargando conjuntos de estudio...",
    loadErrorTitle: "No se pudieron cargar los conjuntos de estudio",
    loadErrorDesc: "Inténtalo de nuevo",
    noSetsYet: "Todavía no hay conjuntos de estudio",
    noSetsYetDesc: "Genera tarjetas o un cuestionario desde cualquier cuaderno para empezar",
    total: "Total",
    filterAll: "Todos",
    itemsCount: "{{count}} elemento(s)",
    view: "Ver",
    deleteSet: "Eliminar",
    deleteSetTitle: "Eliminar Conjunto de Estudio",
    deleteSetDesc: "¿Seguro que quieres eliminar \"{{name}}\"? Esta acción no se puede deshacer.",
    deleteSuccess: "Conjunto de estudio eliminado",
    deleteFailed: "No se pudo eliminar el conjunto de estudio",
    failedLabel: "Fallido",
    backToList: "Volver a Conjuntos de Estudio",
    createdOn: "Creado {{time}}",
    modelUsed: "Modelo",
    notFound: "Conjunto de estudio no encontrado",
    notFoundDesc: "Puede que este conjunto de estudio se haya eliminado.",
    flipCard: "Voltear",
    cardProgress: "Tarjeta {{current}} de {{total}}",
    previous: "Anterior",
    question: "Pregunta {{current}} de {{total}}",
    grade: "Corregir Cuestionario",
    reset: "Reiniciar",
    yourScore: "Tu puntuación: {{score}}/{{total}}",
    correct: "Correcto",
    incorrect: "Incorrecto",
    explanation: "Explicación",
    exportAnki: "Exportar a Anki (.csv)",
    filterDue: "Pendientes de repaso",
    dueCount: "{{count}} pendientes",
    allCaughtUp: "Todo al día",
    reviewPrompt: "¿Qué tan bien lo sabías?",
    reviewAheadHint: "Esta tarjeta aún no tocaba repasarla — repasarla ahora también cuenta.",
    reviewFailed: "No se pudo guardar el repaso",
    rating: {
      again: "De nuevo",
      hard: "Difícil",
      good: "Bien",
    ...
    guidedSession: {
      quickModeTab: "Modo rápido",
      guidedModeTab: "Modo guiado con IA",
      noCardsDue: "No tienes tarjetas pendientes de repaso en este momento.",
      answerPlaceholder: "Escribe tu respuesta...",
      submitAnswer: "Responder",
      grading: "Evaluando tu respuesta...",
      attemptLabel: "Intento {{current}} de {{max}}",
      hintLabel: "Pista de tu intento anterior",
      correctLabel: "¡Correcto!",
      incorrectLabel: "Incorrecto",
      revealedAnswerLabel: "Respuesta",
      tryAgainBtn: "Intentar de nuevo",
      nextCard: "Siguiente tarjeta",
      sessionComplete: "¡Sesión completa!",
      sessionSummary: "Dominaste {{mastered}} de {{total}} tarjetas.",
      allMasteredMessage: "¡Listo! Puedes seguir con el siguiente set.",
      needsWorkTitle: "Tarjetas que necesitan más repaso",
  ...
  drive: {
    title: "Google Drive",
    description: "Conecta una cuenta de Google Drive para importar archivos como fuentes",
    connect: "Conectar Google Drive",
    connectFailed: "Error al conectar Google Drive",
    connected: "Google Drive conectado",
    connectedAs: "Conectado como {{email}}",
    connectedNoEmail: "Conectado",
    notConnected: "No conectado",
    disconnect: "Desconectar",
    disconnected: "Google Drive desconectado",
    disconnectFailed: "Error al desconectar Google Drive",
    importFromDrive: "Importar desde Drive",
    importDialogDesc: "Elige un archivo de tu Google Drive conectado para importarlo como fuente",
    connectPromptDesc: "Conecta Google Drive en Configuración para importar archivos desde ahí",
    goToSettings: "Ir a Configuración",
    searchPlaceholder: "Buscar archivos de Drive...",
    filesLoadError: "Error al cargar los archivos de Drive",
    noFilesFound: "No se encontraron archivos",
    loadMore: "Cargar más",
    import: "Importar",
    importFailed: "Error al importar el archivo de Drive",
  },
  settings: {
  ...
  models: {
    ...
    fallbackChainLabel: "Conmutación automática por error (en orden)",
    fallbackChainEmpty: "No hay modelos de respaldo configurados. Si el modelo principal falla, la solicitud falla.",
    fallbackChainUnknownModel: "Modelo desconocido (¿eliminado?)",
    fallbackChainMoveUp: "Subir",
    fallbackChainMoveDown: "Bajar",
    fallbackChainRemove: "Quitar de la cadena de respaldo",
    fallbackChainAdd: "Añadir modelo de respaldo",
  },
  apiKeys: {
  ...
  askSources: {
    triggerLabel: "Preguntar a varias fuentes",
    title: "Preguntar a varias fuentes a la vez",
    description: "Elegí las fuentes a combinar (libros completos incluidos) y hacé una pregunta — corre en segundo plano así nunca se cuelga, y la respuesta queda guardada como nota.",
    selectSourcesLabel: "Fuentes a incluir",
    noSources: "Este cuaderno todavía no tiene fuentes.",
    questionLabel: "Tu pregunta",
    questionPlaceholder: "¿Qué dicen estas fuentes sobre...?",
    running: "Trabajando...",
    runningDesc: "Puede tardar un poco más con varias fuentes grandes — la respuesta se guardará como nota cuando esté lista.",
    failed: "Algo salió mal generando la respuesta.",
    submitBtn: "Preguntar",
    completeTitle: "Respuesta guardada",
    completeDesc: "Revisá el panel de Notas para ver la respuesta.",
    questionRequired: "Escribí una pregunta primero",
    selectAtLeastOne: "Seleccioná al menos una fuente",
    submitError: "No se pudo iniciar la solicitud",
  },
