...
export const jaJP = {
  ...
  settings: {
    ...
    formulasEnabled: "数式抽出を有効にする",
    formulasHelp: "Doclingエンジン使用時に、ドキュメントから数式を抽出します。処理が遅くなります。",
    visionEnabled: "ビジョンエンリッチメントを有効にする",
    visionHelp: "Doclingエンジン使用時に、ドキュメント内のチャート、画像、図を分析します。大幅に遅くなり、ビジョンモデルを呼び出す可能性があります。",
