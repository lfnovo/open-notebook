export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The SAI Notebook API server could not be reached",
    ...
    docLink: "SAI Notebook Documentation",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow SAI Notebook to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of SAI Notebook is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across SAI Notebook",
    missingRequiredModels: "Missing required models: {models}. SAI Notebook may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in SAI Notebook.",
