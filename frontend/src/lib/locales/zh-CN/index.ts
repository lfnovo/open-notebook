export const zhCN = {
  ...
  connectionErrors: {
    ...
    apiDesc: "无法访问 SAI Notebook API 服务器",
    dbTitle: "数据库连接失败",
  ...
  sources: {
    ...
    includeLinkedPages: "包含链接页面",
    includeLinkedPagesHint: "扫描此页面中的链接，并选择要作为单独来源导入的链接",
    selectLinks: "选择链接",
    selectLinksDescription: "选择要作为单独来源导入的链接页面",
    scanningLinks: "正在扫描页面中的链接…",
    linksFound: "找到 {count} 个链接",
    noLinksFound: "此页面未找到链接。将仅导入原始页面。",
    selectAll: "全选",
    selectNone: "全部取消",
    selectSameDomain: "选择同站点链接",
    sameDomainBadge: "同站点",
    externalBadge: "外部",
    discoverLinksError: "无法扫描页面中的链接。",
    skipImportOriginal: "跳过 — 仅导入原始页面",
    addSource: "添加来源",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "配置用于 SAI Notebook 不同用途的默认模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有这些模型，SAI Notebook 可能无法正常运行。",
  ...
  apiKeys: {
    ...
    description: "将 API 密钥安全地存储在数据库中，以在 SAI Notebook 中启用 AI 服务商。",
