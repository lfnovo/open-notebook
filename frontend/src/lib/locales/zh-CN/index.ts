export const zhCN = {
  ...
  modules: {
    ...
    unarchive: "取消归档",
    deleteModule: "删除笔记本",
    deleteModuleDesc: "您确定要删除此笔记本吗？此操作无法撤销。",
    activeModules: "活动的笔记本",
    archivedModules: "归档的笔记本",
    emptyDescription: "从创建您的第一个笔记本开始，组织您的研究。",
    noActiveModules: "没有活动的笔记本",
    noArchivedModules: "没有归档的笔记本",
    notFound: "未找到笔记本",
  ...
  sources: {
    ...
    cannotSaveNoteNoModule: "无法保存笔记：缺少笔记本 ID",
    empty: "暂无来源",
    ...
    sourcesAddedToModule: "{count} 个来源已添加到笔记本",
    failedToAddSourcesToModule: "添加来源到笔记本失败",
    partialAddSuccess: "{success} 个来源已添加，{failed} 个失败",
    sourceRemovedFromModule: "来源已成功从笔记本中移除",
    failedToRemoveSourceFromModule: "从笔记本中移除来源失败",
    ...
    sourceInsight: "来源见解",
    manageModules: "管理所属笔记本",
    manageModulesDesc: "管理包含此来源的笔记本",
    noModulesAvailable: "暂无可用笔记本",
    deleteInsight: "删除见解",
  ...
  podcasts: {
    ...
    tokens: "{count} token",
    chars: "{count} 字符",
    loadingModules: "正在加载笔记本...",
    noModulesFoundInPodcasts: "未找到笔记本。在生成播客之前，请先创建一个笔记本并添加内容。",
  ...
  models: {
    title: "模型管理",
    desc: "配置用于 Backpack 不同用途的 AI 模型",
    ...
    defaultAssignmentsDesc: "配置用于 Backpack 不同用途的默认模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有这些模型，Backpack 可能无法正常运行。",
