export const jaJP = {
  ...
  podcasts: {
    ...
    podcastLanguage: "Output Language",
    podcastLanguagePlaceholder: "e.g. Spanish, French, Portuguese",
    podcastLanguageDesc: "When set, the AI is explicitly instructed to write all podcast content in this language.",
