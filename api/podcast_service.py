...
from agent_book.domain.notebook import Notebook
from agent_book.podcasts.models import EpisodeProfile, PodcastEpisode, SpeakerProfile
...
class PodcastService:
    ...
    async def submit_generation_job(
        ...
        try:
            ...
            job_id = submit_command("agent_book", "generate_podcast", command_args)
