...
SAI Notebook uses SurrealDB for its database needs. 

---

## Default Configuration

SAI Notebook should work out of the box with SurrealDB as long as the environment variables are correctly setup. 


### DB running in the same docker compose as SAI Notebook (recommended)
...
### DB running in the host machine and SAI Notebook running in Docker
...
### SAI Notebook and Surreal are running on the same machine
