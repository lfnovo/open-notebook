...
export const bnIN = {
  ...
  chat: {
    ...
    selfExplainTitle: "নিজে ব্যাখ্যা করে দেখুন",
    selfExplainDesc: "নিজের ভাষায় বিষয়বস্তু ব্যাখ্যা করা শেখার সবচেয়ে কার্যকর উপায়গুলোর একটি — AI আপনার বোঝাপড়া যাচাই করবে এবং সরাসরি উত্তর দেওয়ার বদলে পাল্টা প্রশ্ন করবে।",
    selfExplainButton: "নিজে ব্যাখ্যা শুরু করুন",
    selfExplainPromptTemplate: "আমি এই বিষয়টি নিজের ভাষায় ব্যাখ্যা করতে যাচ্ছি। আমি যদি কিছু ভুল বলি বা বাদ দিই তা চিহ্নিত করুন, এবং সরাসরি উত্তর না দিয়ে আমাকে \"কেন\" বা \"কীভাবে\" জাতীয় প্রশ্ন করুন। এখানে আমার ব্যাখ্যা: ",
    quickPrompts: {
      triggerLabel: "দ্রুত প্রম্পট",
      dialogTitle: "দ্রুত প্রম্পট",
      dialogDescription: "একটি কথোপকথনের সূচনা বেছে নিন, কয়েকটি তথ্য পূরণ করুন এবং পাঠানোর আগে যাচাই করে নিন।",
      backButton: "ফিরে যান",
      useButton: "এই প্রম্পটটি ব্যবহার করুন",
      templates: {
        interactiveQuiz: {
          title: "ইন্টারঅ্যাক্টিভ কুইজ",
          description: "একে একে প্রশ্ন করে এবং সঙ্গে সঙ্গে সঠিক উত্তর না জানিয়ে প্রতিটি উত্তরের মূল্যায়ন করে।",
        },
        examSimulation: {
          title: "পরীক্ষার সিমুলেশন",
          description: "একাধিক প্রশ্নসহ একটি সম্পূর্ণ পরীক্ষা তৈরি করে এবং উত্তর দেওয়া শেষ হলে তা সংশোধন করে।",
        },
        tutorPersona: {
          title: "ব্যক্তিগত টিউটর",
          description: "পুরো কথোপকথন জুড়ে AI-কে এই বিষয়ের টিউটর হিসেবে কাজ করার জন্য সেট করে।",
        },
        summaryContradictions: {
          title: "সারাংশ ও অসঙ্গতি",
          description: "এই নোটবুকের উৎসগুলোর সারাংশ দেয় এবং তাদের মধ্যে কোনো অসঙ্গতি থাকলে তা চিহ্নিত করে।",
        },
      },
      fields: {
        topic: {
          label: "বিষয়",
          placeholder: "যেমন. ফরাসি বিপ্লব — সম্পূর্ণ বিষয়বস্তুর জন্য খালি রাখুন",
        },
        questionCount: {
        ...
        subject: {
          label: "পাঠ্যবিষয়",
          placeholder: "যেমন. কোষ জীববিজ্ঞান, বিংশ শতাব্দীর ইতিহাস...",
        },
        style: {
          label: "শৈলী",
        },
      ...
      options: {
        ...
        count10: "১০",
        count15: "১৫",
        typeMultipleChoice: "বহুনির্বাচনী",
        typeOpenEnded: "রচনামূলক প্রশ্ন",
        typeMixed: "মিশ্র (বহুনির্বাচনী ও রচনামূলক)",
        styleFriendly: "ধৈর্যশীল ও উৎসাহব্যঞ্জক",
        styleStrict: "কঠোর ও দাবিদার",
        styleDirect: "সরাসরি ও সংক্ষিপ্ত",
      },
    },
  },
  searchPage: {
  ...
  usage: {
    costMeter: "খরচ মিটার",
    costMeterDesc: "নির্বাচিত সময়কালের আনুমানিক LLM খরচ",
    periodMonth: "মাস",
    periodYear: "বছর",
    loadError: "ব্যবহারের তথ্য লোড করতে ব্যর্থ হয়েছে",
    usedOfBudget: "{{budget}} বাজেটের মধ্যে",
    percentUsed: "বাজেটের {{percent}}% ব্যবহৃত হয়েছে",
    inputTokens: "ইনপুট টোকেন",
    outputTokens: "আউটপুট টোকেন",
    byTaskType: "কাজের ধরন অনুযায়ী",
    noUsageYet: "এখনও কোনো ব্যবহার রেকর্ড করা হয়নি",
  },
  study: {
    listTitle: "স্টাডি সেট",
    listDesc: "আপনার নোটবুক থেকে তৈরি ফ্ল্যাশকার্ড ও কুইজ",
    generateBtn: "স্টাডি সেট তৈরি করুন",
    generateTitle: "স্টাডি সেট তৈরি করুন",
    generateDesc: "একটি নোটবুকের বিষয়বস্তু থেকে ফ্ল্যাশকার্ড বা কুইজ তৈরি করুন",
    notebookLabel: "নোটবুক",
    notebookPlaceholder: "একটি নোটবুক নির্বাচন করুন",
    interleavingHint: "নোটবুকের সব সোর্স ও নোট ব্যবহার করে — একটি স্টাডি সেটে মিশিয়ে দিতে জেনারেট করার আগে কয়েকটি ভিন্ন বিষয় যোগ করুন।",
    kindLabel: "ধরন",
    kindFlashcards: "ফ্ল্যাশকার্ড",
    kindQuiz: "কুইজ",
    nameLabel: "নাম",
    namePlaceholder: "যেমন, অধ্যায় ৩ পুনরালোচনা",
    itemCountLabel: "আইটেমের সংখ্যা",
    modelLabel: "মডেল",
    modelDefault: "ডিফল্ট",
    notebookRequired: "নোটবুক প্রয়োজন",
    notebookRequiredDesc: "তৈরি করার জন্য একটি নোটবুক নির্বাচন করুন",
    nameRequired: "নাম প্রয়োজন",
    nameRequiredDesc: "এই স্টাডি সেটের একটি নাম দিন",
    generating: "তৈরি হচ্ছে...",
    generatingDesc: "মডেল ও বিষয়বস্তুর আকারের উপর নির্ভর করে এটি এক মিনিট পর্যন্ত সময় নিতে পারে",
    generationStarted: "তৈরি শুরু হয়েছে",
    generationSubmittedDesc: "\"{{name}}\" প্রস্তুত হলে আমরা আপনাকে জানাব",
    generationComplete: "স্টাডি সেট প্রস্তুত",
    generationCompleteDesc: "\"{{name}}\" অধ্যয়নের জন্য প্রস্তুত",
    generationFailed: "তৈরি ব্যর্থ হয়েছে",
    tryAgain: "আবার চেষ্টা করুন",
    close: "বন্ধ করুন",
    noNotebooks: "এখনও কোনো নোটবুক নেই",
    noNotebooksDesc: "প্রথমে কিছু বিষয়বস্তু সহ একটি নোটবুক তৈরি করুন",
    loadingNotebooks: "নোটবুক লোড হচ্ছে...",
    loadingSets: "স্টাডি সেট লোড হচ্ছে...",
    loadErrorTitle: "স্টাডি সেট লোড করতে ব্যর্থ হয়েছে",
    loadErrorDesc: "আবার চেষ্টা করুন",
    noSetsYet: "এখনও কোনো স্টাডি সেট নেই",
    noSetsYetDesc: "শুরু করতে যেকোনো নোটবুক থেকে ফ্ল্যাশকার্ড বা কুইজ তৈরি করুন",
    total: "মোট",
    filterAll: "সব",
    itemsCount: "{{count}}টি আইটেম",
    view: "দেখুন",
    deleteSet: "মুছে ফেলুন",
    deleteSetTitle: "স্টাডি সেট মুছে ফেলুন",
    deleteSetDesc: "আপনি কি নিশ্চিত যে \"{{name}}\" মুছে ফেলতে চান? এই কাজটি পূর্বাবস্থায় ফেরানো যাবে না।",
    deleteSuccess: "স্টাডি সেট মুছে ফেলা হয়েছে",
    deleteFailed: "স্টাডি সেট মুছতে ব্যর্থ হয়েছে",
    failedLabel: "ব্যর্থ",
    backToList: "স্টাডি সেটে ফিরে যান",
    createdOn: "{{time}} তৈরি হয়েছে",
    modelUsed: "মডেল",
    notFound: "স্টাডি সেট পাওয়া যায়নি",
    notFoundDesc: "এই স্টাডি সেটটি সম্ভবত মুছে ফেলা হয়েছে।",
    flipCard: "উল্টান",
    cardProgress: "কার্ড {{current}} / {{total}}",
    previous: "পূর্ববর্তী",
    question: "প্রশ্ন {{current}} / {{total}}",
    grade: "কুইজ মূল্যায়ন করুন",
    reset: "পুনরায় সেট করুন",
    yourScore: "আপনার স্কোর: {{score}}/{{total}}",
    correct: "সঠিক",
    incorrect: "ভুল",
    explanation: "ব্যাখ্যা",
    exportAnki: "Anki-তে রপ্তানি করুন (.csv)",
    filterDue: "পুনরালোচনার জন্য বাকি",
    dueCount: "{{count}}টি বাকি",
    allCaughtUp: "সব শেষ",
    reviewPrompt: "আপনি এটি কতটা ভালো জানতেন?",
    reviewAheadHint: "এই কার্ডটি এখনো পুনরালোচনার সময় হয়নি — এখন পুনরালোচনা করলেও তা গণনা হবে।",
    reviewFailed: "পুনরালোচনা সংরক্ষণ করা যায়নি",
    rating: {
      again: "আবার",
      hard: "কঠিন",
      good: "ভালো",
    ...
    guidedSession: {
      quickModeTab: "দ্রুত মোড",
      guidedModeTab: "এআই-গাইডেড মোড",
      noCardsDue: "এই মুহূর্তে পুনরালোচনার জন্য কোনো কার্ড নেই।",
      answerPlaceholder: "আপনার উত্তর লিখুন...",
      submitAnswer: "উত্তর দিন",
      grading: "আপনার উত্তর মূল্যায়ন করা হচ্ছে...",
      attemptLabel: "{{max}} এর মধ্যে {{current}} নম্বর চেষ্টা",
      hintLabel: "আপনার আগের চেষ্টার ইঙ্গিত",
      correctLabel: "সঠিক!",
      incorrectLabel: "ভুল",
      revealedAnswerLabel: "উত্তর",
      tryAgainBtn: "আবার চেষ্টা করুন",
      nextCard: "পরবর্তী কার্ড",
      sessionComplete: "সেশন সম্পন্ন!",
      sessionSummary: "আপনি {{total}} টির মধ্যে {{mastered}} টি কার্ড আয়ত্ত করেছেন।",
      allMasteredMessage: "প্রস্তুত! আপনি পরবর্তী সেটে যেতে পারেন।",
      needsWorkTitle: "আরও পুনরালোচনা প্রয়োজন এমন কার্ড",
  ...
  drive: {
    title: "Google Drive",
    description: "ফাইল উৎস হিসেবে আমদানি করতে একটি Google Drive অ্যাকাউন্ট সংযুক্ত করুন",
    connect: "Google Drive সংযুক্ত করুন",
    connectFailed: "Google Drive সংযুক্ত করতে ব্যর্থ হয়েছে",
    connected: "Google Drive সংযুক্ত হয়েছে",
    connectedAs: "{{email}} হিসেবে সংযুক্ত",
    connectedNoEmail: "সংযুক্ত",
    notConnected: "সংযুক্ত নয়",
    disconnect: "সংযোগ বিচ্ছিন্ন করুন",
    disconnected: "Google Drive সংযোগ বিচ্ছিন্ন হয়েছে",
    disconnectFailed: "Google Drive সংযোগ বিচ্ছিন্ন করতে ব্যর্থ হয়েছে",
    importFromDrive: "Drive থেকে আমদানি করুন",
    importDialogDesc: "উৎস হিসেবে আমদানি করতে আপনার সংযুক্ত Google Drive থেকে একটি ফাইল বেছে নিন",
    connectPromptDesc: "ফাইল আমদানি করতে সেটিংসে Google Drive সংযুক্ত করুন",
    goToSettings: "সেটিংসে যান",
    searchPlaceholder: "Drive ফাইল অনুসন্ধান করুন...",
    filesLoadError: "Drive ফাইল লোড করতে ব্যর্থ হয়েছে",
    noFilesFound: "কোনো ফাইল পাওয়া যায়নি",
    loadMore: "আরও লোড করুন",
    import: "আমদানি করুন",
    importFailed: "Drive থেকে ফাইল আমদানি করতে ব্যর্থ হয়েছে",
  },
  settings: {
  ...
  models: {
    ...
    fallbackChainLabel: "স্বয়ংক্রিয় ফলব্যাক (ক্রম অনুসারে)",
    fallbackChainEmpty: "কোনো ফলব্যাক মডেল কনফিগার করা নেই। প্রাথমিক মডেল ব্যর্থ হলে অনুরোধ ব্যর্থ হবে।",
    fallbackChainUnknownModel: "অজানা মডেল (মুছে ফেলা হয়েছে?)",
    fallbackChainMoveUp: "উপরে সরান",
    fallbackChainMoveDown: "নিচে সরান",
    fallbackChainRemove: "ফলব্যাক চেইন থেকে সরান",
    fallbackChainAdd: "ফলব্যাক মডেল যোগ করুন",
  },
  apiKeys: {
  ...
  askSources: {
    triggerLabel: "একাধিক উৎসে জিজ্ঞাসা করুন",
    title: "একসাথে একাধিক উৎসে জিজ্ঞাসা করুন",
    description: "একত্রিত করার জন্য উৎসগুলি বেছে নিন (সম্পূর্ণ বই সহ) এবং একটি প্রশ্ন জিজ্ঞাসা করুন — এটি ব্যাকগ্রাউন্ডে চলে তাই কখনও সময় শেষ হয় না, এবং উত্তরটি নোট হিসেবে সংরক্ষিত হয়।",
    selectSourcesLabel: "অন্তর্ভুক্ত করার উৎস",
    noSources: "এই নোটবুকে এখনও কোনো উৎস নেই।",
    questionLabel: "আপনার প্রশ্ন",
    questionPlaceholder: "এই উৎসগুলি ... সম্পর্কে কী বলে?",
    running: "কাজ চলছে...",
    runningDesc: "একাধিক বড় উৎস থাকলে একটু বেশি সময় লাগতে পারে — প্রস্তুত হলে উত্তরটি নোট হিসেবে সংরক্ষিত হবে।",
    failed: "উত্তর তৈরি করতে গিয়ে কিছু ভুল হয়েছে।",
    submitBtn: "জিজ্ঞাসা করুন",
    completeTitle: "উত্তর সংরক্ষিত হয়েছে",
    completeDesc: "উত্তর দেখতে নোটস প্যানেল দেখুন।",
    questionRequired: "প্রথমে একটি প্রশ্ন লিখুন",
    selectAtLeastOne: "কমপক্ষে একটি উৎস নির্বাচন করুন",
    submitError: "অনুরোধ শুরু করা যায়নি",
  },
